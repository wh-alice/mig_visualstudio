---
title: "Viewing and Modifying Properties of an SCVMM Environment | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
-   Change the environment capabilities in a stored environment so that all active environments created from it will have those capabilities.  
 ...
 In [!INCLUDE[TCMext](../code-quality/includes/tcmext_md.md)], you can view and change active environments by choosing the **Lab** tab. You can view and change stored environments by choosing the **Library** tab.  

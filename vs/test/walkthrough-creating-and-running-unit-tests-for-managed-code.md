...
> [!NOTE]
>  For information about how to run tests from a command line, see [Walkthrough: using the command-line test utility](http://msdn.microsoft.com/en-us/Library/52c11992-9e94-4067-a4b7-59f19d69d867).  

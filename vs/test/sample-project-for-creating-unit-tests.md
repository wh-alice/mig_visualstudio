...
-   [Walkthrough: using the command-line test utility](http://msdn.microsoft.com/en-us/Library/52c11992-9e94-4067-a4b7-59f19d69d867). In this walkthrough, you use the MSTest.exe command-line utility to run tests and view results.  
...
## See Also  
 ...
 [Walkthrough: using the command-line test utility](http://msdn.microsoft.com/en-us/Library/52c11992-9e94-4067-a4b7-59f19d69d867)
...
### Assembly has been installed by NGen  
 ...
 Explanation  
 For performance reasons, native image assemblies are not analyzed. For more information, see [Ngen.exe (Native Image Generator)](http://msdn.microsoft.com/en-us/Library/44bf97aa-a9a4-4eba-9a0d-cfaa6fc53a66).  

...
-   ![Prerequsite](../codequality/media/prereq.png "Prereq") In this version of Visual Studio, there are some [compatibility issues of test settings with Visual Studio 2010](http://msdn.microsoft.com/en-us/c4f0f924-6a92-4fdb-a16b-6c3ef6f0acca) to be aware of:  
...
-   ![Prerequsite](../codequality/media/prereq.png "Prereq") You can [create custom diagnostic data adapters](../test/b0b53fae-7007-4ad9-a604-21685937622f.md) to fulfill a specific testing requirement that is not included in the standard adapters.  

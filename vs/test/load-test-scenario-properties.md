---
title: "Load Test Scenario Properties | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
|Property|Definition|  
|--------------|----------------|  
|**Name**|The name for the scenario.<br /><br /> For more information, see [Creating load tests](../test_notintoc/creating-load-tests.md) and [Create and run a load test](http://msdn.microsoft.com/en-us/7041cbcf-9ab1-4579-98ff-8f296aeaded4).|  

---
title: "IDiaSourceFile::get_checksum | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
## Remarks  
 To determine the type of checksum algorithm that was used to generate the checksum bytes, call the [IDiaSourceFile::get_checksumType](../debug-interface-access/idiasourcefile--get_checksumtype.md) method.  
...
## See Also  
 ...
 [IDiaSourceFile::get_checksumType](../debug-interface-access/idiasourcefile--get_checksumtype.md)
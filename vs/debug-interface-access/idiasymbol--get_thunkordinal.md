---
title: "IDiaSymbol::get_thunkOrdinal | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `pRetVal`  
 [out] Returns a value from the [THUNK_ORDINAL Enumeration](../debug-interface-access/thunk_ordinal.md) enumeration that specifies the thunk type of a function.  
...
## Remarks  
 This property is valid only if the symbol as a [SymTagEnum Enumeration](../debug-interface-access/symtagenum.md) value of `SymTagThunk`.  

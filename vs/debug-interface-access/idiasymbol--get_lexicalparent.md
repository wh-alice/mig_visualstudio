---
title: "IDiaSymbol::get_lexicalParent | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `pRetVal`  
 [out] Returns an [IDiaSymbol](../debug-interface-access/idiasymbol.md) object that represents the lexical parent of the symbol.  
...
## Remarks  
 ...
 The possible symbols that can appear as lexical parents are documented in [Lexical Hierarchy of Symbol Types](../debug-interface-access/lexical-hierarchy-of-symbol-types.md).  

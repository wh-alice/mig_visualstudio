---
title: "IDiaSymbol::get_virtualBaseTableType | hehe"
ms.custom: ""
ms.date: "10/20/2016"
...
|---------------|-----------------|  
|`pRetVal`|[out] Returns an [IDiaSymbol](../debug-interface-access/idiasymbol.md) object that specifies the type of base table.|  
...
## Remarks  
 ...
 This method returns an [IDiaSymbol](../debug-interface-access/idiasymbol.md) object that can be used to determine the size of the vbtptr.  

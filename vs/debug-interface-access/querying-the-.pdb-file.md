---
title: "Querying the .Pdb File | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
2.  Call [IDiaDataSource::loadDataFromPdb](../debug-interface-access/idiadatasource--loaddatafrompdb.md) or [IDiaDataSource::loadDataForExe](../debug-interface-access/idiadatasource--loaddataforexe.md) to load the debugging information.  
...
3.  Call [IDiaDataSource::openSession](../debug-interface-access/idiadatasource--opensession.md) to open an [IDiaSession](../debug-interface-access/idiasession.md) to gain access to the debugging information.  

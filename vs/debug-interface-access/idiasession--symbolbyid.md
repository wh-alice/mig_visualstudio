---
title: "IDiaSession::symbolById | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
## Example  
 This example retrieves an [IDiaSymbol](../debug-interface-access/idiasymbol.md) representing the type of another symbol. This example shows how to use the `symbolById` method in the session. A simpler approach is to call the [IDiaSymbol::get_type](../debug-interface-access/idiasymbol--get_type.md) method to retrieve the type symbol directly.  
...
## See Also  
 ...
 [IDiaSymbol::get_type](../debug-interface-access/idiasymbol--get_type.md)
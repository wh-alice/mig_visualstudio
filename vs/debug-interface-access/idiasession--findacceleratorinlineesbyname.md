---
title: "IDiaSession::findAcceleratorInlineesByName | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 ...
 `option`  
 [in] The name search options to be used when searching for inline frames that correspond to `name`. For more information, see [NameSearchOptions Enumeration](../debug-interface-access/namesearchoptions.md).  

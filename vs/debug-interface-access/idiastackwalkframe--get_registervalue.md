---
title: "IDiaStackWalkFrame::get_registerValue | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `index`  
 [in] A value from the [CV_HREG_e Enumeration](../debug-interface-access/cv_hreg_e.md) enumeration specifying the register to get the value for.  

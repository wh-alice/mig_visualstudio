---
title: "IDiaSymbol::get_offset | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
Retrieves the offset of the symbol location. Use when the [LocationType Enumeration](../debug-interface-access/locationtype.md) is `LocIsRegRel` or `LocIsBitField`.  

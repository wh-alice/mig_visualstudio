---
title: "IDiaEnumDebugStreamData::Item | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 index  
 [in] Index of the record to be retrieved. The index is in the range 0 to `count`-1, where `count` is returned by [IDiaEnumDebugStreamData::get_Count](../debug-interface-access/idiaenumdebugstreamdata--get_count.md).  
...
## See Also  
 ...
 [IDiaEnumDebugStreamData::Next](../debug-interface-access/idiaenumdebugstreamdata--next.md)   
 [IDiaEnumDebugStreams::Item](../debug-interface-access/idiaenumdebugstreams--item.md)   
 [IDiaEnumDebugStreamData::get_Count](../debug-interface-access/idiaenumdebugstreamdata--get_count.md)   
 [IDiaEnumDebugStreamData::Skip](../debug-interface-access/idiaenumdebugstreamdata--skip.md)
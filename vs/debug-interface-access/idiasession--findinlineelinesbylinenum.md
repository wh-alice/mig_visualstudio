---
title: "IDiaSession::findInlineeLinesByLinenum | hehe"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 ...
 `file`  
 [in] An [IDiaSourceFile](../debug-interface-access/idiasourcefile.md) object that represents the source file in which to search. This parameter cannot be `NULL`.  

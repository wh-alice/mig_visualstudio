---
title: "IDiaSymbol::get_isSplitted | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
## Remarks  
 The [IDiaSymbol::get_isAggregated](../debug-interface-access/idiasymbol--get_isaggregated.md) method returns `TRUE` for all symbols that are part of a split symbol.  
...
## See Also  
 ...
 [IDiaSymbol::get_isAggregated](../debug-interface-access/idiasymbol--get_isaggregated.md)
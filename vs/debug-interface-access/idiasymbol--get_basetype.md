---
title: "IDiaSymbol::get_baseType | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `pRetVal`  
 [out] Returns a value from the [BasicType Enumeration](../debug-interface-access/basictype.md) enumeration specifying the base type of the symbol.  

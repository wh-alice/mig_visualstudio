...
-   You can also compare (diff) two snapshots of an app to find areas in your code that cause the memory use to increase over time.  
 ...
 You can also use the memory tool outside of the debugger. See [Memory Usage without Debugging](http://msdn.microsoft.com/en-us/Library/8883bc5f-df86-4f84-aa2b-a21150f499b0).  

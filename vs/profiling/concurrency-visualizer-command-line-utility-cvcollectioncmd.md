...
|------------|-----------------|----------------|-------------------|  
|Query|Returns whether collection can be started.|None|0 if collection is ready to start.<br /><br /> 1  if collection is already in progress.<br /><br /> 2 if collection isn’t in progress, but one or more of the required [ETW](http://msdn.microsoft.com/en-us/Library/ac99a063-e2d2-40cc-b659-d23c2f783f92) sessions is already enabled.|  

...
##  <a name="MEF"></a> Defining Gesture Handlers by using MEF  
 MEF (Managed Extensibility Framework) lets you define components that can be installed with minimal configuration. For more information, see [Managed Extensibility Framework (MEF)](http://msdn.microsoft.com/en-us/Library/6c61b4ec-c6df-4651-80f1-4854f8b14dde).  

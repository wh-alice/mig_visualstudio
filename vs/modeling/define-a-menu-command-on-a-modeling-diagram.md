...
2.  Add the following references to your project.  
    ...
    |---------------|--------------------------------|  
    |System.ComponentModel.Composition|Define components by using [Managed Extensibility Framework (MEF)](http://msdn.microsoft.com/en-us/Library/6c61b4ec-c6df-4651-80f1-4854f8b14dde).|  

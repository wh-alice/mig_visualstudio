...
This topic describes how to debug [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)]-based [!INCLUDE[wf](../WF_Design/includes/wf_md.md)] applications that target either the [!INCLUDE[netfx35_long](../WF_Design/includes/netfx35_long_md.md)] or the [!INCLUDE[vstecwinfx](../WF_Design/includes/vstecwinfx_md.md)] in the legacy [!INCLUDE[wfd1](../WF_Design/includes/wfd1_md.md)].  

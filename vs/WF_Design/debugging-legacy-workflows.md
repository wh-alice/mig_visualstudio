...
If you are using the legacy [!INCLUDE[wfd1](../WF_Design/includes/wfd1_md.md)] in [!INCLUDE[vs_current_long](../VS_not_in_toc/includes/vs_current_long_md.md)] to build [!INCLUDE[wf](../WF_Design/includes/wf_md.md)] applications that target.NET Framework 3.0 or 3.5, you can debug your workflows like any other program by setting breakpoints, attaching to processes, and examining threads and the call stack. You also have the option of debugging remotely.  
...
>  If either of these scenarios occurs when debugging .NET Framework 3.0 or 3.5 workflows, perform a repair of the Visual Studio installation.  
 ...
 [!INCLUDE[wf2](../WF_Design/includes/wf2_md.md)] integrates with the following standard [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] debug windows:  

...
To facilitate creating larger, more complicated workflows, [!INCLUDE[net_v45](../VS_IDE/includes/net_v45_md.md)] allows the developer to add annotations to the following types of item in the designer:  

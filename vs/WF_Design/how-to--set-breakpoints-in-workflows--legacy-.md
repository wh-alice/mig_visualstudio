...
This topic describes how to set breakpoints in [!INCLUDE[wf](../WF_Design/includes/wf_md.md)] applications build using the legacy [!INCLUDE[wfd1](../WF_Design/includes/wfd1_md.md)]. Use the legacy [!INCLUDE[wfd2](../WF_Design/includes/wfd2_md.md)] when your [!INCLUDE[wf2](../WF_Design/includes/wf2_md.md)] application needs to target either the [!INCLUDE[netfx35_long](../WF_Design/includes/netfx35_long_md.md)] or the [!INCLUDE[vstecwinfx](../WF_Design/includes/vstecwinfx_md.md)].  
  
 When you use the legacy [!INCLUDE[wfd2](../WF_Design/includes/wfd2_md.md)] in [!INCLUDE[vs2010](../dv_TeamTestALM/includes/vs2010_md.md)] to build a [!INCLUDE[wf2](../WF_Design/includes/wf2_md.md)] application, you can set breakpoints in C# and Visual Basic code as you do in Visual Studio. As expected, workflow execution stops at each breakpoint that you set.  

...
Custom activities are used to model your particular business processes in a workflow. The Activity Library template in [!INCLUDE[vs2010](../dv_TeamTestALM/includes/vs2010_md.md)] has been provided to enable you to create such custom activities visually using the [!INCLUDE[wfd1](../WF_Design/includes/wfd1_md.md)].  
...
8.  The project template creates an activity definition in XAML. [!INCLUDE[wfd1](../WF_Design/includes/wfd1_md.md)] opens and displays the canvas for your custom activity.  

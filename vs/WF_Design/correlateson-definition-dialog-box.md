...
The **CorrelatesOn** dialog box is used in [!INCLUDE[wfd1](../WF_Design/includes/wfd1_md.md)] to edit the \<xref:System.ServiceModel.Activities.Receive.CorrelatesOn*> property of a \<xref:System.ServiceModel.Activities.Receive> activity. [!INCLUDE[crdefault](../dv_TeamTestALM/includes/crdefault_md.md)] the [Receive](../WF_Design/receive-activity-designer.md) topic.  

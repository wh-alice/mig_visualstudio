...
The Workflow Designer in [!INCLUDE[netfx40_short](../WF_Design/includes/netfx40_short_md.md)] added many new features, but there are still some debugging scenarios that it does not support. This document details unsupported Workflow Designer debugging scenarios.  
...
-   Workflows created in earlier versions of [!INCLUDE[wf](../WF_Design/includes/wf_md.md)] cannot be debugged in the [!INCLUDE[netfx40_short](../WF_Design/includes/netfx40_short_md.md)] designer.  

...
1.  Open a WCF Workflow service application, workflow console application, or activity library project in [!INCLUDE[vs2010](../dv_TeamTestALM/includes/vs2010_md.md)] or a rehosted workflow application.  

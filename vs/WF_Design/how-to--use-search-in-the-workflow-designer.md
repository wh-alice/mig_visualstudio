...
3.  The find result will be shown in the [!INCLUDE[vs_current_short](../VS_debugger/includes/vs_current_short_md.md)]**Find Result** view. Double-clicking a result item will navigate to the activity which contains the match in workflow designer.
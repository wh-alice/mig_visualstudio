...
This topic describes how to declare a rule condition using the legacy [!INCLUDE[wfd1](../WF_Design/includes/wfd1_md.md)] that targets the [!INCLUDE[netfx35_long](../WF_Design/includes/netfx35_long_md.md)] or the [!INCLUDE[vstecwinfx](../WF_Design/includes/vstecwinfx_md.md)].  

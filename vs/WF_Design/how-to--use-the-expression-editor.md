...
> [!NOTE]
>  IntelliSense for the Expression Editor is available only inside of [!INCLUDE[vs2010](../dv_TeamTestALM/includes/vs2010_md.md)]. In both the [!INCLUDE[vs2010](../dv_TeamTestALM/includes/vs2010_md.md)] and the rehosted scenarios, the compiler validates the expression after it is entered and the expression editor displays an error icon if the expression is invalid.  
  
### Using the Expression editor  
  
1.  In [!INCLUDE[vs2010](../dv_TeamTestALM/includes/vs2010_md.md)], open a new or existing workflow project.  

...
This topic describes how to debug [!INCLUDE[wf](../WF_Design/includes/wf_md.md)] applications that have concurrent activities in the legacy [!INCLUDE[wfd1](../WF_Design/includes/wfd1_md.md)]. Use the legacy [!INCLUDE[wfd2](../WF_Design/includes/wfd2_md.md)] when you need to target either the [!INCLUDE[netfx35_long](../WF_Design/includes/netfx35_long_md.md)] or the [!INCLUDE[vstecwinfx](../WF_Design/includes/vstecwinfx_md.md)].  

...
This topic describes how to implement a [!INCLUDE[indigo1](../WF_Design/includes/indigo1_md.md)] contract operation using the legacy [!INCLUDE[wfd1](../WF_Design/includes/wfd1_md.md)] that targets the [!INCLUDE[netfx35_long](../WF_Design/includes/netfx35_long_md.md)] or the [!INCLUDE[vstecwinfx](../WF_Design/includes/vstecwinfx_md.md)].  
  
 After dragging a **ReceiveActivity** activity from the toolbox to the workflow design surface, you will either create a new [!INCLUDE[indigo2](../WF_Design/includes/indigo2_md.md)] contract or import an existing contract and implement the operations. You select and/or create your contract and its operations through the [Choose Operation Dialog Box (Legacy)](../WF_Design/choose-operation-dialog-box--legacy-.md).  
...
2.  Do one of the following:  
    ...
    -   Click **Add Contract** in the upper-right corner of the dialog box. This will create a new [!INCLUDE[indigo2](../WF_Design/includes/indigo2_md.md)] contract and operation for you.  

...
This topic describes how use the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Debugger to debug [!INCLUDE[wf](../WF_Design/includes/wf_md.md)] applications in the legacy [!INCLUDE[wfd1](../WF_Design/includes/wfd1_md.md)]. Use the legacy [!INCLUDE[wfd2](../WF_Design/includes/wfd2_md.md)] when you need to target either the [!INCLUDE[netfx35_long](../WF_Design/includes/netfx35_long_md.md)] or the [!INCLUDE[vstecwinfx](../WF_Design/includes/vstecwinfx_md.md)].  
  
 Generally, you debug legacy workflows just like you debug programs written in other Visual Studio programming languages. You can start the [!INCLUDE[vs_current_long](../VS_not_in_toc/includes/vs_current_long_md.md)] Debugger for Windows Workflow Foundation in the following ways:  

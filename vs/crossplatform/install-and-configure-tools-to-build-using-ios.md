...
##  <a name="Install"></a> Install the remote agent for iOS  
 ...
 Before you install the remote agent, make sure you have satisfied the [Prerequisites](#Prerequisites) and installed [Visual C++ for Cross-Platform Mobile Development](../crossplatform/install-visual-c---for-cross-platform-mobile-development.md#InstallTheTools).  
...
-   From the Terminal app on your Mac, enter:  
 ...
 ![Use vcremote to generate a secure PIN](../crossplatform/media/cppmdd_vcremote_generateclientcert.png "CPPMDD_vcremote_generateClientCert")  
...
7.  Choose **Pair** to enable the pairing.  
     ...
     ![Configure vcremote connection for iOS builds](../crossplatform/media/cppmdd_options_ios.PNG "CPPMDD_Options_iOS")  
...
## See Also  
 [Install Visual C++ for Cross-Platform Mobile Development](../crossplatform/install-visual-c---for-cross-platform-mobile-development.md)
...
---
# LC Task
Wraps LC.exe, which generates a .license file from a .licx file. For more information on LC.exe, see [Lc.exe (License Compiler)](http://msdn.microsoft.com/en-us/Library/2de803b8-495e-4982-b209-19a72aba0460).  
...
|`Sources`|Required <xref:Microsoft.Build.Framework.ITaskItem>`[]` parameter.<br /><br /> Specifies the items that contain licensed components to include in the .licenses file. For more information, see the documentation for the `/complist` switch in [Lc.exe (License Compiler)](http://msdn.microsoft.com/en-us/Library/2de803b8-495e-4982-b209-19a72aba0460).|  

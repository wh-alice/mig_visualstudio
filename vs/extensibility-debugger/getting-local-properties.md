---
title: "Getting Local Properties | testtitle"
ms.custom: ""
ms.date: "10/21/2016"
...
2.  Calls [Next](../extensibility-debugger-reference/ienumdebugfields--next.md) for each local, storing the returned [DEBUG_PROPERTY_INFO](../extensibility-debugger-reference/debug_property_info.md) in the array to be returned. The [IEnumDebugFields](../extensibility-debugger-reference/ienumdebugfields.md) object was supplied when this `CEnumPropertyInfo` class was instantiated.  

---
title: "SendAndReceiveReply Template Designer | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
### Using the SendAndReceiveReply Template Designer  
 ...
 [!INCLUDE[crabout](../code-quality/includes/crabout_md.md)] using the **Send** designer to configure the <xref:System.ServiceModel.Activities.Send> activity, see the [Send](../workflow-designer/send-activity-designer.md) topic.  
  
 [!INCLUDE[crabout](../code-quality/includes/crabout_md.md)] using the **ReceiveReplyForSend** designer to configure the <xref:System.ServiceModel.Activities.ReceiveReply> activity, see the following section.  

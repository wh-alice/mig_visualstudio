---
title: "How to: Create Workflow Projects (Legacy) | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
Follow these steps to create a [!INCLUDE[wf](../workflow-designer/includes/wf_md.md)] project that targets the [!INCLUDE[netfx35_long](../workflow-designer/includes/netfx35_long_md.md)] or the [!INCLUDE[vstecwinfx](../workflow-designer/includes/vstecwinfx_md.md)]. This procedure uses the legacy [!INCLUDE[wfd1](../workflow-designer/includes/wfd1_md.md)] provided by [!INCLUDE[vs2010](../code-quality/includes/vs2010_md.md)].  

...
4.  Create the endpoint configuration in your configuration file, if it does not exist already. For more information about configuring your client, see [WCF Client Overview](http://msdn.microsoft.com/en-us/Library/f60d9bc5-8ade-4471-8ecf-5a07a936c82d).  

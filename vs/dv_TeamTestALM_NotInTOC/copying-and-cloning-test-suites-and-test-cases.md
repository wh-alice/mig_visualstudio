...
There are several ways to duplicate test suites and test cases when you are [planning tests](../dv_TeamTestALM/planning-manual-tests-using-the-web-portal.md) in [!INCLUDE[vstsTfsExt](../dv_TeamTestALM/includes/vststfsext_md.md)] (TFS).  

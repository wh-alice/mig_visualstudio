...
10. To use your diagnostic data adapter in testing, you must select from the list of existing test settings or create a new one from [!INCLUDE[TCMext](../dv_TeamTestALM/includes/tcmext_md.md)] or Visual Studio and then select your diagnostic data adapter.  

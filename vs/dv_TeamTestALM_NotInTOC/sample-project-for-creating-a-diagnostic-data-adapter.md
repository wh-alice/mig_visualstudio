...
-   Apply attributes to make a class discoverable to [!INCLUDE[TCMext](../dv_TeamTestALM/includes/tcmext_md.md)] as a diagnostic data adapter.  
  
-   Apply attributes to make a user control class discoverable to [!INCLUDE[TCMext](../dv_TeamTestALM/includes/tcmext_md.md)] as an editor to use to change the configuration for a diagnostic data adapter.  

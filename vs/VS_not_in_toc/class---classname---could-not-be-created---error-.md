...
A class initialization has failed. One possible cause is a corrupted [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] installation.  
...
2.  Reinstall the [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] and recompile the program.  

...
[!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Help contains the following documents about the **Properties** window but cannot determine which one best applies to your help request. Select the document that best corresponds to the task you are trying to accomplish.  

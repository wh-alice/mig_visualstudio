...
'(' unexpected. Arrays of uninstantiated generic types are not allowed.  
 ...
 [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] cannot compile an array unless it is of a specific data type. You cannot use a data-type parameter of a generic type as the data type of an array.  

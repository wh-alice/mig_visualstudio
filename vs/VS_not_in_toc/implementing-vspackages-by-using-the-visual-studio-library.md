...
-   \<xref:Microsoft.VisualStudio.Shell.Interop.IVsPackage.GetPropertyPage*>  
    ...
    > [!NOTE]
    >  The [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Package Template generates all the code discussed here. You can save time by using the template to generate a VSPackage for you.  

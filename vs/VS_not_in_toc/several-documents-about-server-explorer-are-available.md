...
[!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Help contains the following documents about **Server Explorer** that may apply to your Help request. Select the document that best corresponds to the task you are trying to accomplish.  
...
|[Server Explorer](../Topic/Server%20Explorer.md)|Describes the **Server Explorer**/**Database Explorer**, which is the server management console for [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].|  
...
|[Local Data Overview](../VS_raddata/local-data-overview.md)|Describes how to convert a database file (.mdf) to a format that is used by [!INCLUDE[vs_dev11_long](../dv_TeamTestALM/includes/vs_dev11_long_md.md)].|
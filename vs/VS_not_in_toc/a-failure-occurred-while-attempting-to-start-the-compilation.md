...
An unknown error has been encountered while issuing the **Start Build** request to the [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] or [!INCLUDE[csprcs](../VS_debugger/includes/csprcs_md.md)] compiler.  
  
 **To correct this error**  
  
-   Restart [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  

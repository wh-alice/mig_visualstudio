...
The Progress Bar region of the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] status bar displays the incremental progress of quick operations, for example, saving a file to disk.  
...
## Example  
 ...
 [!code[VSSDKProgressStatusBar#1](../VS_not_in_toc/codesnippet/CSharp/how-to--program-the-progress-bar-region-of-the-status-bar_1.cs)]
[!code[VSSDKProgressStatusBar#1](../VS_not_in_toc/codesnippet/VisualBasic/how-to--program-the-progress-bar-region-of-the-status-bar_1.vb)]  

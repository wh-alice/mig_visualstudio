...
1.  Create a console application, and then paste the following code into it:  
     ...
     [!code[csAsyncDebugging#1](../VS_not_in_toc/codesnippet/CSharp/walkthrough--using-the-debugger-with-async-methods_1.cs)]
[!code[csAsyncDebugging#1](../VS_not_in_toc/codesnippet/VisualBasic/walkthrough--using-the-debugger-with-async-methods_1.vb)]  
...
### Obtaining and then awaiting a task  
 ...
 [!code[csAsyncDebugging#2](../VS_not_in_toc/codesnippet/CSharp/walkthrough--using-the-debugger-with-async-methods_2.cs)]
[!code[csAsyncDebugging#2](../VS_not_in_toc/codesnippet/VisualBasic/walkthrough--using-the-debugger-with-async-methods_2.vb)]  
...
1.  Replace the code in the console application with the following code.  
     ...
     [!code[csAsyncDebugging#3](../VS_not_in_toc/codesnippet/CSharp/walkthrough--using-the-debugger-with-async-methods_3.cs)]
[!code[csAsyncDebugging#3](../VS_not_in_toc/codesnippet/VisualBasic/walkthrough--using-the-debugger-with-async-methods_3.vb)]  
...
1.  Replace the code in the console application with the following code.  
     ...
     [!code[csAsyncDebugging#4](../VS_not_in_toc/codesnippet/CSharp/walkthrough--using-the-debugger-with-async-methods_4.cs)]
[!code[csAsyncDebugging#4](../VS_not_in_toc/codesnippet/VisualBasic/walkthrough--using-the-debugger-with-async-methods_4.vb)]  

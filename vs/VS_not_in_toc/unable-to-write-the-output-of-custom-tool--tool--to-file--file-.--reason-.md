...
-   Restart [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] and rerun the custom tool by right-clicking the affected file and selecting **Run Custom Tool** from the shortcut menu.  

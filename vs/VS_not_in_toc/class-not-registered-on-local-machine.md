...
This error is usually encountered as a result of a corrupted file. You may need to reinstall [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
  
### To correct this error  
  
-   Reinstall [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  

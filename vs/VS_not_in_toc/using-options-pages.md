...
---
# Using Options Pages
The [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] automation model provides the \<xref:EnvDTE.DTE> object to enable VSPackages to access the **Options** dialog box on the **Tools** menu.  
  
 Typically, pages in the **Options** dialog box can be accessed by using the automation model, whether the pages are provided by the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] integrated development environment (IDE) or by a VSPackage. However, there are some exceptions, as follows:  
...
```  
 ...
 [!code[UI_UserSettings_ToolsOptionPages#01](../VS_not_in_toc/codesnippet/CSharp/using-options-pages_1.cs)]
[!code[UI_UserSettings_ToolsOptionPages#01](../VS_not_in_toc/codesnippet/VisualBasic/using-options-pages_1.vb)]  
...
```  
 ...
 [!code[UI_UserSettings_ToolsOptionPages#02](../VS_not_in_toc/codesnippet/CSharp/using-options-pages_2.cs)]
[!code[UI_UserSettings_ToolsOptionPages#02](../VS_not_in_toc/codesnippet/VisualBasic/using-options-pages_2.vb)]  
...
```  
 ...
 [!code[UI_UserSettings_ToolsOptionPages#03](../VS_not_in_toc/codesnippet/CSharp/using-options-pages_3.cs)]
[!code[UI_UserSettings_ToolsOptionPages#03](../VS_not_in_toc/codesnippet/VisualBasic/using-options-pages_3.vb)]  
...
## Persisting Options Page Settings  
 The IDE implements state persistence of **Options** pages that fully support the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] automation model.  

...
3.  If the error continues, save your work and restart [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
  
4.  If the error reoccurs, reinstall [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)].  

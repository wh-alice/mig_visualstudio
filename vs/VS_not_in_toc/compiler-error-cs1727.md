...
Cannot send error report automatically without authorization. Please visit '' to authorize sending error report.  
 ...
 The Web site listed in the error text explains how to enable automatic error reporting for [!INCLUDE[vsprvslong](../VS_debugger/includes/vsprvslong_md.md)] command line tools.  

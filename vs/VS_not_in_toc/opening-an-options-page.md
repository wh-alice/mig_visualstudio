...
3.  Call the \<xref:Microsoft.VisualStudio.Shell.Package.ShowOptionPage*> method by using the \<xref:System.Type> of the options page as a parameter.  
     ...
     [!code[UI_UserSettings_ToolsOptionPages#5](../VS_not_in_toc/codesnippet/CSharp/opening-an-options-page_1.cs)]
[!code[UI_UserSettings_ToolsOptionPages#5](../VS_not_in_toc/codesnippet/VisualBasic/opening-an-options-page_1.vb)]  
...
3.  Call the \<xref:System.ComponentModel.Design.MenuCommandService.GlobalInvoke*> method by using the \<xref:System.ComponentModel.Design.CommandID> instance and the GUID string as parameters.  
     ...
     [!code[UI_UserSettings_ToolsOptionPages#6](../VS_not_in_toc/codesnippet/CSharp/opening-an-options-page_2.cs)]
[!code[UI_UserSettings_ToolsOptionPages#6](../VS_not_in_toc/codesnippet/VisualBasic/opening-an-options-page_2.vb)]
...
A derived class does not declare a constructor, and [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] cannot generate one because there is no base class constructor it can call.  

...
The [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] compiler cannot successfully interpret one of its internally written files.  
...
2.  If the error recurs, reinstall the [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] compiler.  

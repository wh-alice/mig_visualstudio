...
The [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Package Template creates a basic implementation of a VSPackage that you can expand later. You can also use the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Package Template to add optional components to a VSPackage.  

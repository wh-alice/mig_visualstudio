...
You can create a VSIX package to wrap a [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] extension for deployment. There are three ways to create the package:  
  
-   Create a VSIX package project by using one of the extensibility templates that are included in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] SDK. This is the easiest option for most scenarios.  

...
You can add menus and toolbars to many different user interface (UI) elements of your VSPackage or the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] integrated development environment (IDE). The walkthroughs in this section lead you through the most common scenarios.  
...
## In This Section  
 ...
 Demonstrates how to add a toolbar to the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] IDE.  

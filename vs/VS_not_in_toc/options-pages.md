...
## In This Section  
 ...
 Provides an overview of how a VSPackage can use the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] automation model to manage the state of **Tools Options** pages.  

 ...
 *projectfolder*\obj\\`configname`\temppe  
 ...
 outputdir  
 The directory specified by the Output Path property. See [Build Page, Project Designer (C#)](../VS_IDE/build-page--project-designer--csharp-.md) for more information.  

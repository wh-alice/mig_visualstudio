...
## MSBuild CodeAnalysisRules property  
 In [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] code analysis, rules can be specified by using the CodeAnalysisRules property of MSBuild with the following format:  

...
-   Use the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Package project template  
...
-   Build your VSPackage without the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Package project template  

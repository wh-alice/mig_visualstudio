...
This section discusses how to build and install VSPackages and how to support users who are running multiple versions of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] at the same time.  
  
## In This Section  
 [Supporting Multiple Versions of Visual Studio](../Topic/Supporting%20Multiple%20Versions%20of%20Visual%20Studio.md)  
 Describes issues related to multiple versions of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] and your VSPackage during development and deployment to end users.  
...
## Related Sections  
 ...
 Provides a set of tests to help make sure that VSPackages correctly integrate into [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
  
 [Releasing a Product](../VS_not_in_toc/releasing-a-visual-studio-integration-product.md)  
 Shows how to release a [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] integration product.
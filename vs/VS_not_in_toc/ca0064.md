...
-   Otherwise, this warning usually occurs when your ruleset is empty or all of the rule enabled in child ruleset have been disabled. Use the [!INCLUDE[vs_current_short](../VS_debugger/includes/vs_current_short_md.md)] ruleset editor to enable some rules in your ruleset. For more information, see [Creating Custom Rule Sets](../VS_IDE/creating-custom-code-analysis-rule-sets.md).  

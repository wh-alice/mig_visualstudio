...
Unsafe code may only appear if compiling with /unsafe  
 ...
 To set the unsafe option in [!INCLUDE[vs_current_long](../VS_not_in_toc/includes/vs_current_long_md.md)], click on **Project** in the main menu, select the **Build** pane, and check the box that says "allow unsafe code."  

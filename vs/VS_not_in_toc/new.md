...
|[ref new, gcnew](../Topic/ref%20new,%20gcnew%20%20\(C++%20Component%20Extensions\).md)|In a [!INCLUDE[cppwrt_short](../VS_not_in_toc/includes/cppwrt_short_md.md)] (`ref new`) or C++/CLI (`gcnew`) project, this compound keyword creates a reference-counted object.|
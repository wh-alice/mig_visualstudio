...
-   COM methods that regularly return two or more different success codes, for example, \<xref:Microsoft.VisualStudio.VSConstants.S_OK> or \<xref:Microsoft.VisualStudio.VSConstants.S_FALSE>, cannot be distinguished.  
 ...
 Because many of the [!INCLUDE[vsipsdk](../VS_IDE/includes/vsipsdk_md.md)] COM functions either return HRESULT values less than zero or return different success codes, the [!INCLUDE[vsipsdk](../VS_IDE/includes/vsipsdk_md.md)] interop assemblies have been written so that the method signatures are preserved. All [!INCLUDE[vsipsdk](../VS_IDE/includes/vsipsdk_md.md)] interop methods are of `int` type. HRESULT values are passed through the interop layer without alteration and without generating exceptions.  
...
>  The \<xref:Microsoft.VisualStudio.VSConstants> class contains constants for common HRESULTS, for example, \<xref:Microsoft.VisualStudio.VSConstants.S_OK> and \<xref:Microsoft.VisualStudio.VSConstants.E_NOTIMPL>, and [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] HRESULTS, for example, \<xref:Microsoft.VisualStudio.VSConstants.VS_E_INCOMPATIBLEDOCDATA> and \<xref:Microsoft.VisualStudio.VSConstants.VS_E_UNSUPPORTEDFORMAT>. \<xref:Microsoft.VisualStudio.VSConstants> also provides the \<xref:Microsoft.VisualStudio.ErrorHandler.Succeeded*> and \<xref:Microsoft.VisualStudio.ErrorHandler.Failed*> methods, which correspond to the SUCCEEDED and FAILED macros in COM.  
 ...
 [!code[VSSDKHRESULTInformation#1](../VS_not_in_toc/codesnippet/VisualBasic/hresult-information-in-managed-code_1.vb)]
[!code[VSSDKHRESULTInformation#1](../VS_not_in_toc/codesnippet/CSharp/hresult-information-in-managed-code_1.cs)]  
 ...
 [!code[VSSDKHRESULTInformation#2](../VS_not_in_toc/codesnippet/VisualBasic/hresult-information-in-managed-code_2.vb)]
[!code[VSSDKHRESULTInformation#2](../VS_not_in_toc/codesnippet/CSharp/hresult-information-in-managed-code_2.cs)]  

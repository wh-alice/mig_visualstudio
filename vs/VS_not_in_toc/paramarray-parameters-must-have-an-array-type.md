...
2.  If the error recurs, save your work and restart [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
  
3.  If the error persists, reinstall [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)].  

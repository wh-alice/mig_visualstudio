...
-   Reinstall Visual Studio (if the assembly came with [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] or the [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)]).  

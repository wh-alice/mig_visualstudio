...
You have made an edit to a section of code that is not allowed in Visual C# Edit and Continue.  
 ...
 [!INCLUDE[csharp_current_short](../VS_IDE/includes/csharp_current_short_md.md)] Edit and Continue lets you stop program execution in Break mode, make changes to the executing code, and then resume program execution with the newly incorporated changes.  
 ...
 For more information about supported edits in Edit and Continue for [!INCLUDE[csharp_current_short](../VS_IDE/includes/csharp_current_short_md.md)], see [Supported Code Changes (C#)](../VS_debugger/supported-code-changes--csharp-.md). If you need more information about a specific error or warning, you can search or post on the MSDN [Visual C# IDE forum](http://go.microsoft.com/fwlink/?LinkId=214693).  

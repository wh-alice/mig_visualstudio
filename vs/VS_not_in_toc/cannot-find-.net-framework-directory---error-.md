...
The directory where the [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] assemblies are stored could not be located.  
...
2.  If the error continues, save your work and restart [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
  
3.  If the error recurs, reinstall [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)].  

...
The [!INCLUDE[vsipsdk](../VS_IDE/includes/vsipsdk_md.md)] allows a VSPackage, such as an editor or designer, to manage the membership and appearance of the **Toolbox**.  
...
## Controlling the Toolbox  
 Supplementing automation support, the [!INCLUDE[vsipsdk](../VS_IDE/includes/vsipsdk_md.md)] provides the following interfaces to provide VSPackages greater control over how the **Toolbox** is managed.  

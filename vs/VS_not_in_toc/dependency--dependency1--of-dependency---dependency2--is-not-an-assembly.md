...
-   Reinstall [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] (if the assembly came with [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] or the .NET Framework).  

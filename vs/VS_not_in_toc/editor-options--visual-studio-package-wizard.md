 ...
 **File Extension**  
 Define the file name extension that is associated with your editor. You can specify multiple extensions by typing a comma-delimited list. Your editor is the default [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] editor for files that have the file name extension you define.  

...
The [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] **Toolbox** provides a collection of objects that provide functionality to editors and designers through the IDE's drag-and-drop mechanism.  
  
 There are two basic ways in which a VSPackage works with the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] **Toolbox**:  
...
## Related Sections  
 ...
 Describes how to work with the **Toolbox** in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] integrated development environment (IDE).  
 ...
 Explains how to use [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] services to create UI elements that match the rest of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].
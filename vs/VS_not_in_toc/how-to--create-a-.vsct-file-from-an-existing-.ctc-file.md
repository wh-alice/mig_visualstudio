...
You can create an XML-based .vsct file from an existing command table .ctc source file. By doing this, you can take advantage of the new XML-based [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] command table (VSCT) compiler format.  
...
5.  In the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Command Prompt window, navigate to the directory.  

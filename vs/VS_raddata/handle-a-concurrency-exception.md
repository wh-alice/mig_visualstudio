...
1.  Add the following code below the `Form1_Load` method:  
     ...
     [!code[VbRaddataConcurrency#1](../VS_raddata/codesnippet/CSharp/handle-a-concurrency-exception_1.cs)]
[!code[VbRaddataConcurrency#1](../VS_raddata/codesnippet/VisualBasic/handle-a-concurrency-exception_1.vb)]  
...
2.  Replace the `CustomersBindingNavigatorSaveItem_Click` method to call the `UpdateDatabase` method so it looks like the following:  
     ...
     [!code[VbRaddataConcurrency#2](../VS_raddata/codesnippet/CSharp/handle-a-concurrency-exception_2.cs)]
[!code[VbRaddataConcurrency#2](../VS_raddata/codesnippet/VisualBasic/handle-a-concurrency-exception_2.vb)]  
...
-   Create the message by adding the following code to the **Code Editor**. Enter this code below the `UpdateDatabase` method.  
     ...
     [!code[VbRaddataConcurrency#4](../VS_raddata/codesnippet/CSharp/handle-a-concurrency-exception_3.cs)]
[!code[VbRaddataConcurrency#4](../VS_raddata/codesnippet/VisualBasic/handle-a-concurrency-exception_3.vb)]  
...
-   Add the following code below the code that was added in the previous section.  
     ...
     [!code[VbRaddataConcurrency#3](../VS_raddata/codesnippet/CSharp/handle-a-concurrency-exception_4.cs)]
[!code[VbRaddataConcurrency#3](../VS_raddata/codesnippet/VisualBasic/handle-a-concurrency-exception_4.vb)]  

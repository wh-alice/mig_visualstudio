...
> [!NOTE]
>  [!INCLUDE[vs_dev11_long](../dv_TeamTestALM/includes/vs_dev11_long_md.md)] has changes that apply to the Northwind database file (.mdf). For information, see [How to: Install Sample Databases](../VS_raddata/how-to--install-sample-databases.md).  

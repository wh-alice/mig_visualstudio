...
After the data in your dataset has been modified and validated, you probably want to send the updated data back to a database. In order to send the modified data to a database, you call the `Update` method of a [TableAdapter](../VS_raddata/tableadapter-overview.md) or data adapter. The adapter's `Update` method updates a single data table and executes the correct command (INSERT, UPDATE, or DELETE) based on the \<xref:System.Data.DataRow.RowState*> of each data row in the table.  
...
-   Enclose the `TableAdapter.Update` method inside a `try`/`catch` block. The following example shows how to attempt an update with the contents of the `Customers` table in the `NorthwindDataSet`.  
     ...
     [!code[VbRaddataSaving#9](../VS_raddata/codesnippet/CSharp/how-to--save-dataset-changes-to-a-database_1.cs)]
[!code[VbRaddataSaving#9](../VS_raddata/codesnippet/VisualBasic/how-to--save-dataset-changes-to-a-database_1.vb)]  
...
-   Enclose the `DataAdapter.Update` method inside a `try`/`catch` block. The following example shows how to attempt an update to a data source with the contents of `Table1` in `DataSet1`.  
     ...
     [!code[VbRaddataSaving#26](../VS_raddata/codesnippet/VisualBasic/how-to--save-dataset-changes-to-a-database_2.vb)]
[!code[VbRaddataSaving#26](../VS_raddata/codesnippet/CSharp/how-to--save-dataset-changes-to-a-database_2.cs)]  
...
4.  Dispose of the temporary data tables to release the resources.  
     ...
     [!code[VbRaddataSaving#27](../VS_raddata/codesnippet/VisualBasic/how-to--save-dataset-changes-to-a-database_3.vb)]
[!code[VbRaddataSaving#27](../VS_raddata/codesnippet/CSharp/how-to--save-dataset-changes-to-a-database_3.cs)]  
...
-   Call the `Update` method of each data adapter.  
     ...
     [!code[VbRaddataSaving#28](../VS_raddata/codesnippet/VisualBasic/how-to--save-dataset-changes-to-a-database_4.vb)]
[!code[VbRaddataSaving#28](../VS_raddata/codesnippet/CSharp/how-to--save-dataset-changes-to-a-database_4.cs)]  

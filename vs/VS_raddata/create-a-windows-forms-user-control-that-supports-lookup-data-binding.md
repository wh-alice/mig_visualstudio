...
2.  Replace the code in the `LookupBox` with the following:  
     ...
     [!code[VbRaddataDisplaying#5](../VS_raddata/codesnippet/VisualBasic/create-a-windows-forms-user-control-that-supports-lookup-data-binding_1.vb)]
[!code[VbRaddataDisplaying#5](../VS_raddata/codesnippet/CSharp/create-a-windows-forms-user-control-that-supports-lookup-data-binding_1.cs)]  

...
2.  Double-click the title bar of the table you want to validate. This action automatically creates the \<xref:System.Data.DataTable.RowChanging> event handler of the \<xref:System.Data.DataTable> in the dataset's partial-class file.  
    ...
    >  Double-click to the left of the table name to create the row-changing event handler. If you double-click the table name, you can edit it.  
     ...
     [!code[VbRaddataValidating#3](../VS_raddata/codesnippet/VisualBasic/validate-data-in-datasets_1.vb)]  
...
-   Call the \<xref:System.Data.DataSet.GetChanges*> method of a dataset.  
     ...
     [!code[VbRaddataEditing#14](../VS_raddata/codesnippet/CSharp/validate-data-in-datasets_2.cs)]
[!code[VbRaddataEditing#14](../VS_raddata/codesnippet/VisualBasic/validate-data-in-datasets_2.vb)]  
...
-   Call the \<xref:System.Data.DataTable.GetChanges*> method of a DataTable.  
     ...
     [!code[VbRaddataEditing#15](../VS_raddata/codesnippet/CSharp/validate-data-in-datasets_3.cs)]
[!code[VbRaddataEditing#15](../VS_raddata/codesnippet/VisualBasic/validate-data-in-datasets_3.vb)]  
...
-   Call the `GetChanges` method of a dataset or data table and pass a \<xref:System.Data.DataRowState> enumeration value as an argument.  
     ...
     [!code[VbRaddataEditing#16](../VS_raddata/codesnippet/CSharp/validate-data-in-datasets_4.cs)]
[!code[VbRaddataEditing#16](../VS_raddata/codesnippet/VisualBasic/validate-data-in-datasets_4.vb)]  
  
-   The following example shows how to return all records that were recently added to the `Customers` table:  
  
     [!code[VbRaddataEditing#17](../VS_raddata/codesnippet/CSharp/validate-data-in-datasets_5.cs)]
[!code[VbRaddataEditing#17](../VS_raddata/codesnippet/VisualBasic/validate-data-in-datasets_5.vb)]  
...
-   Access the value of a column by passing in the \<xref:System.Data.DataRowVersion> of the row you want to return.  
     ...
     [!code[VbRaddataEditing#21](../VS_raddata/codesnippet/CSharp/validate-data-in-datasets_6.cs)]
[!code[VbRaddataEditing#21](../VS_raddata/codesnippet/VisualBasic/validate-data-in-datasets_6.vb)]  
...
-   Access the value of a column, and then add a parameter to the index that indicates which version of a row you want to return.  
     ...
     [!code[VbRaddataEditing#22](../VS_raddata/codesnippet/CSharp/validate-data-in-datasets_7.cs)]
[!code[VbRaddataEditing#22](../VS_raddata/codesnippet/VisualBasic/validate-data-in-datasets_7.vb)]  

...
-   Call the TableAdapter's `Insert` method, passing in the values for each column as parameters. The following procedure uses the `Region` table in the Northwind databaseas an example.  
    ...
    >  If you do not have an instance available, instantiate the TableAdapter that you want to use.  
     ...
     [!code[VbRaddataSaving#15](../VS_raddata/codesnippet/VisualBasic/directly-access-the-database-with-a-tableadapter_1.vb)]
[!code[VbRaddataSaving#15](../VS_raddata/codesnippet/CSharp/directly-access-the-database-with-a-tableadapter_1.cs)]  
...
-   Call the TableAdapter's `Update` method, passing in the new and original values for each column as parameters.  
    ...
    >  If you do not have an instance available, instantiate the TableAdapter that you want to use.  
     ...
     [!code[VbRaddataSaving#18](../VS_raddata/codesnippet/VisualBasic/directly-access-the-database-with-a-tableadapter_2.vb)]
[!code[VbRaddataSaving#18](../VS_raddata/codesnippet/CSharp/directly-access-the-database-with-a-tableadapter_2.cs)]  
...
-   Call the TableAdapter's `Delete` method, passing in the values for each column as parameters of the `Delete` method. The following procedure uses the `Region` table in the Northwind databaseas an example.  
    ...
    >  If you do not have an instance available, instantiate the TableAdapter that you want to use.  
     ...
     [!code[VbRaddataSaving#21](../VS_raddata/codesnippet/VisualBasic/directly-access-the-database-with-a-tableadapter_3.vb)]
[!code[VbRaddataSaving#21](../VS_raddata/codesnippet/CSharp/directly-access-the-database-with-a-tableadapter_3.cs)]  

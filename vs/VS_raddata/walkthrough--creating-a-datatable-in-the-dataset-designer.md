...
This walkthrough explains how to create a \<xref:System.Data.DataTable> (without a TableAdapter) using the **Dataset Designer**. For information on creating data tables that include TableAdapters, see [Create and configure TableAdapters](../VS_raddata/create-and-configure-tableadapters.md).  

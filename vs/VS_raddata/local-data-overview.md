...
|[How to: Connect to the Northwind Database](../VS_raddata/how-to--connect-to-the-northwind-database.md)|Provides instructions for connecting to the Northwind sample database in [!INCLUDE[ssNoVersion](../dv_TeamTestALM/includes/ssnoversion_md.md)], SQL Server Compact, SQL Server Express, and Access.|  

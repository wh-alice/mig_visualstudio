...
3.  Type the following code into the `ReadXmlButton_Click` event handler:  
     ...
     [!code[VbRaddataFillingAndExecuting#2](../VS_raddata/codesnippet/CSharp/read-xml-data-into-a-dataset_1.cs)]
[!code[VbRaddataFillingAndExecuting#2](../VS_raddata/codesnippet/VisualBasic/read-xml-data-into-a-dataset_1.vb)]  
...
3.  Type the following code into the `ShowSchemaButton_Click` event handler.  
     ...
     [!code[VbRaddataFillingAndExecuting#3](../VS_raddata/codesnippet/CSharp/read-xml-data-into-a-dataset_2.cs)]
[!code[VbRaddataFillingAndExecuting#3](../VS_raddata/codesnippet/VisualBasic/read-xml-data-into-a-dataset_2.vb)]  

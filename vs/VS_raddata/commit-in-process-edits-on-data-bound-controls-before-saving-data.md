...
1.  Add the following code to the form that contains the \<xref:System.Windows.Forms.BindingSource> components.  
     ...
     [!code[VSProDataOrcasEndEditOnAll#1](../VS_raddata/codesnippet/CSharp/commit-in-process-edits-on-data-bound-controls-before-saving-data_1.cs)]
[!code[VSProDataOrcasEndEditOnAll#1](../VS_raddata/codesnippet/VisualBasic/commit-in-process-edits-on-data-bound-controls-before-saving-data_1.vb)]  
...
2.  Add the following line of code immediately before any calls to save the form's data (the `TableAdapterManager.UpdateAll()` method):  
     ...
     [!code[VSProDataOrcasEndEditOnAll#2](../VS_raddata/codesnippet/CSharp/commit-in-process-edits-on-data-bound-controls-before-saving-data_2.cs)]
[!code[VSProDataOrcasEndEditOnAll#2](../VS_raddata/codesnippet/VisualBasic/commit-in-process-edits-on-data-bound-controls-before-saving-data_2.vb)]  

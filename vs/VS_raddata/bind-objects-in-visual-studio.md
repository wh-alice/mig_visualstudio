...
>  Visual Studio names the TableAdapter queries `Fill` and `GetData` by default, but those names can be changed to any valid method name.  
 ...
 [!code[VbRaddataConnecting#4](../VS_raddata/codesnippet/CSharp/bind-objects-in-visual-studio_1.cs)]
[!code[VbRaddataConnecting#4](../VS_raddata/codesnippet/VisualBasic/bind-objects-in-visual-studio_1.vb)]  
...
>  If your collection requires functionality not provided by the base implementation of the <xref:System.ComponentModel.BindingList`1>, you should create a custom collection so you can add to the class as needed.  
 ...
 [!code[VbRaddataConnecting#8](../VS_raddata/codesnippet/CSharp/bind-objects-in-visual-studio_2.cs)]
[!code[VbRaddataConnecting#8](../VS_raddata/codesnippet/VisualBasic/bind-objects-in-visual-studio_2.vb)]  
...
>  The `Add` method is automatically provided for your custom collection when you inherit from <xref:System.ComponentModel.BindingList`1>.  
 ...
 [!code[VbRaddataConnecting#5](../VS_raddata/codesnippet/CSharp/bind-objects-in-visual-studio_3.cs)]
[!code[VbRaddataConnecting#5](../VS_raddata/codesnippet/VisualBasic/bind-objects-in-visual-studio_3.vb)]  
...
>  In this example the `Orders` collection is a property of the `Customer` object.  
 ...
 [!code[VbRaddataConnecting#6](../VS_raddata/codesnippet/CSharp/bind-objects-in-visual-studio_4.cs)]
[!code[VbRaddataConnecting#6](../VS_raddata/codesnippet/VisualBasic/bind-objects-in-visual-studio_4.vb)]  
...
>  The `Remove` and `RemoveAt` methods are automatically provided for your custom collection when you inherit from <xref:System.ComponentModel.BindingList`1>.  
 ...
 [!code[VbRaddataConnecting#7](../VS_raddata/codesnippet/CSharp/bind-objects-in-visual-studio_5.cs)]
[!code[VbRaddataConnecting#7](../VS_raddata/codesnippet/VisualBasic/bind-objects-in-visual-studio_5.vb)]  
...
|`TableAdapter.Delete`|Deletes existing records from the database based on the original column values passed in as method parameters.|  
 ...
 [!code[VbRaddataSaving#23](../VS_raddata/codesnippet/CSharp/bind-objects-in-visual-studio_6.cs)]
[!code[VbRaddataSaving#23](../VS_raddata/codesnippet/VisualBasic/bind-objects-in-visual-studio_6.vb)]  

...
-   Drag the main **Region** node from the **Data Sources** window onto the form.  
     ...
     A \<xref:System.Windows.Forms.DataGridView> control and a tool strip (\<xref:System.Windows.Forms.BindingNavigator>) for navigating records appear on the form. A [NorthwindDataSet](../VS_raddata/dataset-tools-in-visual-studio.md), [RegionTableAdapter](../VS_raddata/tableadapter-overview.md), \<xref:System.Windows.Forms.BindingSource>, and \<xref:System.Windows.Forms.BindingNavigator> appear in the component tray.  
...
2.  Replace the `InsertButton_Click` event handler with the following code:  
     ...
     [!code[VbRaddataSaving#1](../VS_raddata/codesnippet/VisualBasic/save-data-with-the-tableadapter-dbdirect-methods_1.vb)]
[!code[VbRaddataSaving#1](../VS_raddata/codesnippet/CSharp/save-data-with-the-tableadapter-dbdirect-methods_1.cs)]  
...
2.  Replace the `UpdateButton_Click` event handler with the following code:  
     ...
     [!code[VbRaddataSaving#2](../VS_raddata/codesnippet/VisualBasic/save-data-with-the-tableadapter-dbdirect-methods_2.vb)]
[!code[VbRaddataSaving#2](../VS_raddata/codesnippet/CSharp/save-data-with-the-tableadapter-dbdirect-methods_2.cs)]  
...
2.  Replace the `DeleteButton_Click` event handler with the following code:  
     ...
     [!code[VbRaddataSaving#3](../VS_raddata/codesnippet/VisualBasic/save-data-with-the-tableadapter-dbdirect-methods_3.vb)]
[!code[VbRaddataSaving#3](../VS_raddata/codesnippet/CSharp/save-data-with-the-tableadapter-dbdirect-methods_3.cs)]  

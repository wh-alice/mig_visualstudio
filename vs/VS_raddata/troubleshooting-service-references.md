...
This topic lists common issues that may occur when you are working with [!INCLUDE[vsindigo](../VS_not_in_toc/includes/vsindigo_md.md)] or [!INCLUDE[ssAstoria](../VS_raddata/includes/ssastoria_md.md)] references in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
...
## WCF Data Services Do Not Display in the Browser  
 When it attempts to view an XML representation of data in a [!INCLUDE[ss_data_service](../VS_raddata/includes/ss_data_service_md.md)], Internet Explorer may misinterpret the data as an RSS feed. You must make sure that the option to display RSS feeds is disabled.  

...
This walkthrough demonstrates how to create a simple [!INCLUDE[vsindigo](../VS_not_in_toc/includes/vsindigo_md.md)] service, test it, and then access it from a Windows Forms application.  
...
3.  ![The IService1 file](../VS_raddata/media/wcf2.png "wcf2")  
     ...
     [!code[WCFWalkthrough#4](../VS_raddata/codesnippet/CSharp/walkthrough--creating-a-simple-wcf-service-in-windows-forms_1.cs)]
[!code[WCFWalkthrough#4](../VS_raddata/codesnippet/VisualBasic/walkthrough--creating-a-simple-wcf-service-in-windows-forms_1.vb)]  
  
     Change the type for the `value` parameter to `String`:  
  
     [!code[WCFWalkthrough#1](../VS_raddata/codesnippet/CSharp/walkthrough--creating-a-simple-wcf-service-in-windows-forms_2.cs)]
[!code[WCFWalkthrough#1](../VS_raddata/codesnippet/VisualBasic/walkthrough--creating-a-simple-wcf-service-in-windows-forms_2.vb)]  
...
4.  ![The Service1 file](../VS_raddata/media/wcf3.png "wcf3")  
     ...
     [!code[WCFWalkthrough#5](../VS_raddata/codesnippet/VisualBasic/walkthrough--creating-a-simple-wcf-service-in-windows-forms_3.vb)]
[!code[WCFWalkthrough#5](../VS_raddata/codesnippet/CSharp/walkthrough--creating-a-simple-wcf-service-in-windows-forms_3.cs)]  
  
     Change the type for the value parameter to `String`:  
  
     [!code[WCFWalkthrough#2](../VS_raddata/codesnippet/CSharp/walkthrough--creating-a-simple-wcf-service-in-windows-forms_4.cs)]
[!code[WCFWalkthrough#2](../VS_raddata/codesnippet/VisualBasic/walkthrough--creating-a-simple-wcf-service-in-windows-forms_4.vb)]  
...
3.  Double-click the `Button`, and add the following code in the `Click` event handler:  
     ...
     [!code[WCFWalkthrough#3](../VS_raddata/codesnippet/CSharp/walkthrough--creating-a-simple-wcf-service-in-windows-forms_5.cs)]
[!code[WCFWalkthrough#3](../VS_raddata/codesnippet/VisualBasic/walkthrough--creating-a-simple-wcf-service-in-windows-forms_5.vb)]  

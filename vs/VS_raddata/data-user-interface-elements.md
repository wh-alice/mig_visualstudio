...
This section contains information about all the dialog boxes and wizards that you use when designing data access in your [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] or Visual C# applications.  

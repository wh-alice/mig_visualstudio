...
|**SQL Tracing Directory**|The location where the SQL Trace file is put after the trace ends. This directory must have write permissions for [!INCLUDE[ssNoVersion](../dv_TeamTestALM/includes/ssnoversion_md.md)] and read permissions for the controller.|  

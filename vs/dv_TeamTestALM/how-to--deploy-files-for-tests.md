...
-   Files and directories that you have specified explicitly, either by using \<xref:Microsoft.VisualStudio.TestTools.UnitTesting.DeploymentItemAttribute> or in a [*.testsettings](../dv_TeamTestALM/specifying-test-settings-for-visual-studio-tests.md) file  

...
10. Type your [!INCLUDE[ssNoVersion](../dv_TeamTestALM/includes/ssnoversion_md.md)] instance in **Create load test results database in the following SQL Server instance**.  

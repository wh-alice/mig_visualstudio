...
You manage lab environments, physical machines, virtual machines, and templates in [!INCLUDE[TCMshort](../dv_TeamTestALM/includes/tcmshort_md.md)], in **Lab Center**, using the **Lab** and **Library** tabs.  

...
4.  (Optional) If you want to view the environment as the build progresses, open [!INCLUDE[TCMext](../dv_TeamTestALM/includes/tcmext_md.md)], locate the **Lab Center**, choose **Lab**, and then choose your SCVMM environment in the list. You can view the progress of the build and the details of your lab environment as follows:  
...
1.  From the **Builds** folder in [!INCLUDE[esprtfc](../dv_TeamTestALM/includes/esprtfc_md.md)], open the shortcut menu for your workflow and choose **View Builds**.  

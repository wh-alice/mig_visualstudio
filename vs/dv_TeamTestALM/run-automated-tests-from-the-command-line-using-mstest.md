...
1.  Open a [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] command prompt.  
     ...
     By default, the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] command prompt opens to the following folder:  
...
2.  Either change directory to your solution folder or, when you run the MSTest.exe program in step 3, specify a full or relative path to the metadata file or to the test container.  
     ...
     To identify your solution folder, first identify the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Projects folder. To do this, choose **Options** on the **Tools** menu in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], and then choose **Projects and Solutions**. Under **Visual Studio projects location**, you see a path such as the following:  
...
> [!WARNING]
>  Test lists are no longer fully supported in [!INCLUDE[vs_dev11_long](../dv_TeamTestALM/includes/vs_dev11_long_md.md)]:  
>   

...
|[!INCLUDE[vstsTestEssLong](../dv_TeamTestALM/includes/vststestesslong_md.md)]|Visual Studio Enterprise|[!INCLUDE[vs_pro_current_short](../dv_TeamTestALM/includes/vs_pro_current_short_md.md)]|[!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Express|  
|---------------------------------------------------------------------|------------------------------|--------------------------------------------------------------------------|--------------------------------------------------------------------|  
...
9. Run your test as usual.  
     ...
     For more information about how to create test settings to use in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], see [Specifying Test Settings for Visual Studio Tests](../dv_TeamTestALM/specifying-test-settings-for-visual-studio-tests.md).  

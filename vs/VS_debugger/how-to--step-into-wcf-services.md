...
In [!INCLUDE[vs_dev11_long](../dv_TeamTestALM/includes/vs_dev11_long_md.md)], you can step into a WCF service. If the WCF service is in the same [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] solution as the client, you can hit breakpoints inside the WCF Service.  
...
1.  Create a [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] solution that contains both the WCF client and WCF service projects.  

...
After you have created a visualizer, you must install the visualizer so that it will be available in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)]. Installing a visualizer is a simple process.  

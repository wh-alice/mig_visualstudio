...
The code in this topic is the sample file for the [Navigate a debug session  (Xaml and C#)](../VS_debugger/navigate-a-debugging-session-in-visual-studio--xaml-and-csharp-.md) topic.  

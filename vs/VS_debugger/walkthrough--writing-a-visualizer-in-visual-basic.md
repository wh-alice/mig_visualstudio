...
2.  Change the name from Class1.vb to something meaningful, such as DebuggerSide.vb.  
    ...
    > [!NOTE]
    >  [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] automatically changes the class declaration in DebuggerSide.vb to match the new file name.  
...
## Create a Test Harness  
 At this point, your first visualizer is finished. If you have followed the steps correctly, you can build the visualizer and install it into [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)]. Before you install a visualizer into [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], however, you should test it to make sure that it runs correctly. You will now create a test harness to run the visualizer without installing it into [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
...
2.  Edit the name from Module1.vb to something appropriate, such as **TestConsole.vb**.  
     ...
     Notice that [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] automatically changes the class declaration in TestConsole.vb to match the new file name.  
...
2.  On the **Debug** menu, click **Start**.  
 ...
 If you want to use your visualizer in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] rather than just calling it from the test harness, you have to install it. For more information, see [How to: Install a Visualizer](../VS_debugger/how-to--install-a-visualizer.md).  

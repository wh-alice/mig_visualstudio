...
3.  If the console application window has focus at this point, click in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] window to return focus to [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
...
## Flagging and Unflagging Threads  
 In [!INCLUDE[vs_orcas_long](../dv_TeamTestALM/includes/vs_orcas_long_md.md)], you can flag threads that you want to give special attention. Flagging threads is a good way to keep track of important threads and ignore threads you do not care about.  
...
6.  Right-click the main thread and then click **Switch to Thread**.  
     ...
     A warning dialog box appears. It tells you that [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] cannot display source code for the main thread.  

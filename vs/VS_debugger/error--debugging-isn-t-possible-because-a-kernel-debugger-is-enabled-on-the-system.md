...
-   on a [!INCLUDE[win7](../dv_TeamTestALM/includes/win7_md.md)] or [!INCLUDE[wiprlhext](../dv_TeamTestALM/includes/wiprlhext_md.md)]system that has been started in debug mode.  
...
-   Disable kernel debugging and debug in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
  
     —or—  
  
-   Debug using the Kernel Debugger instead of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  

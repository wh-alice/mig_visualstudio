...
#### Parameters  
 ...
 `pcsig70`  
 [in] The GUID signature to verify against the .pdb file signature. Only .pdb files in [!INCLUDE[vcprvc](../VS_debugger/includes/vcprvc_md.md)] and later have GUID signatures.  

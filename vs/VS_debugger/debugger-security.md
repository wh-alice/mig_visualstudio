...
### External Components  
 Be aware of the trust status of external components that your program interacts with, especially if you did not write the code. Also be aware of components that [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] or the debugger might use.  
  
### Symbols and Source Code  
 Two [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] tools that require thinking about security are the following:  

...
2.  In the **Installed Templates** pane, select either Visual C#, Visual Basic, or Visual C++. For the managed languages, ensure that [!INCLUDE[net_v40_short](../VS_debugger/includes/net_v40_short_md.md)] is displayed in the framework box.  
...
5.  Paste the following code for your chosen language into the empty code file.  
 ...
 [!code[Debugger#1](../VS_debugger/codesnippet/CSharp/walkthrough--debugging-a-parallel-application_1.cs)]
[!code[Debugger#1](../VS_debugger/codesnippet/CPP/walkthrough--debugging-a-parallel-application_1.cpp)]
[!code[Debugger#1](../VS_debugger/codesnippet/VisualBasic/walkthrough--debugging-a-parallel-application_1.vb)]  

...
To set up your computer so that you can run the [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] worker process (aspnet_wp.exe or w3wp.exe) under a user account, follow these steps.  
...
4.  On [!INCLUDE[winxpsvr](../dv_TeamTestALM/includes/winxpsvr_md.md)], IIS 6.0 is installed by default. The corresponding worker process is w3wp.exe.To run in IIS 6.0 mode with aspnet_wp.exe as the worker process, you must follow these steps:  
...
6.  Locate the Temporary [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Files folder, which should be in the same path as the CONFIG folder. Right-click the Temporary [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Files folder and choose **Properties** on the shortcut menu.  

...
## Example of fixing a CSS rule  
 This example shows how to inspect CSS rules and debug a style issue. For this example, let's say that you want to change the color of a font used to display group titles in the [!INCLUDE[win8_appname_long](../VS_debugger/includes/win8_appname_long_md.md)] Split App template.  
...
1.  In Visual Studio, create a [!INCLUDE[win8_appname_long](../VS_debugger/includes/win8_appname_long_md.md)] app using JavaScript and HTML in the Split App project template.  

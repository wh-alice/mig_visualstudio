...
The steps in this walkthrough show you how to debug an [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Web application, also known as a Web Form. It shows you how to start and stop execution, set breakpoints, and examine variables in the **Watch** window.  
  
> [!NOTE]
>  To complete this walkthrough, you must have Administrator privileges on the server computer. By default, the [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] process, aspnet_wp.exe or w3wp.exe, runs as an [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] process. To debug [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)], you must have Administrator privileges on the computer where [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] runs it. For more information, see [System Requirements](../VS_debugger/asp.net-debugging--system-requirements.md).  
...
6.  Click **OK**.  
     ...
     [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] creates a new project, and displays the default HTML source code. It also creates a new virtual directory named **WebSite** under **Default Web Site** in IIS.  
...
11. Double-click the button control you dropped.  
     ...
     This takes you to the code page: Default.aspx.cs for C# or Default.aspx.vb for [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)]. The cursor should be in the function `Button1_Click`.  
...
4.  In Internet Explorer, click the button.  
     ...
     In [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], this takes you to the line where you set your breakpoint on the code page Default.aspx.cs or Default.aspx.vb. This line should be highlighted in yellow. You can now view the variables in your application and control its execution. Your application stops executing and waits for a command from you.  
...
1.  In [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], you can attach the debugger to a running process. For most effective debugging, compile the executable as a Debug version with symbol (PDB) files.  
...
4.  Attach to the [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] process. For more information, see [Debugging Deployed Web Applications](../VS_debugger/debugging-deployed-web-applications.md).  
  
5.  In Internet Explorer, click the button on your form.  
  
     In [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], you should hit the breakpoint in Default.aspx.cs, Default.aspx.vb, or Default.aspx.  

 ...
 **C++ options**  
 ...
 In [!INCLUDE[vcprvc](../VS_debugger/includes/vcprvc_md.md)], the [/Fd](../Topic/-Fd%20\(Program%20Database%20File%20Name\).md) option names the .pdb file created by the compiler. When you create a project in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] using wizards, the **/Fd** option is set to create a .pdb file named *project*.pdb.  

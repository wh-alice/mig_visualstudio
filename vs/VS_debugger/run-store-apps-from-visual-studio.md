...
|[Run Windows Store apps in the simulator](../VS_debugger/run-windows-store-apps-in-the-simulator.md)|Run your Windows Store app in a desktop window that simulates [!INCLUDE[win8_appname_long](../VS_debugger/includes/win8_appname_long_md.md)] functionality such as touch and orientation.|  

...
The error reads:  
 ...
 This error can occur when you are trying to step into a web service (see [Stepping Into an XML Web Service](assetId:///8e67de38-bf5f-41cc-a457-1b88ce63d764)). It can occur whenever [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] is not set up properly.  
  
 Possible causes are:  
  
-   The web.config file for your [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] application does not set debug to "true" in (see [Debug Mode in ASP.NET Applications](../VS_debugger/how-to--enable-debugging-for-asp.net-applications.md)).  
  
-   A version of [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] was installed after Visual Studio was installed. [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] should be installed before Visual Studio. To fix this problem, use the Windows **Control Panel**, **Programs and Features** to repair your Visual Studio installation.  

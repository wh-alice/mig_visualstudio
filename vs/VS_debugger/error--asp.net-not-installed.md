...
This error occurs when [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] is not installed correctly on the computer that you are trying to debug. This might mean that [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] was never installed or that [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] was installed first and IIS was installed later.  
...
1.  From a command prompt window, run the following command:  
    ...
    > [!NOTE]
    >  With Windows Server 2003, you can install [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] by using **Add or Remove Programs** in Control Panel.  

...
To debug mixed native and managed code in a 64-bit process, you must have [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] version 4. Mixed-mode debugging of 64-bit processes with [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] versions earlier than 4 is not supported.  
  
### To correct this error  
  
-   Perform one of the following steps:  
  
    -   Upgrade your [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] to version 4.  

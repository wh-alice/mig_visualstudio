...
To attach to a running [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] application, you have to know the name of the [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] process:  

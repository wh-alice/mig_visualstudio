...
2.  Change the name from Class1.cs to something meaningful, such as DebuggerSide.cs.  
    ...
    > [!NOTE]
    >  [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] automatically changes the class declaration in DebuggerSide.cs to match the new file name.  
...
2.  Edit the name from Program.cs to something more meaningful, such as TestConsole.cs.  
     ...
     **Note** [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] automatically changes the class declaration in TestConsole.cs to match the new file name.  

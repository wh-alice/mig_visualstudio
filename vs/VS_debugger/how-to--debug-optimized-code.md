...
>   
>  [Edit and Continue](../VS_debugger/edit-and-continue--visual-csharp-.md) is disabled when the **/Zo** ocompiler option is used.  
...
9. Select the Configuation Properties, C/C++, Command Line node of the project properties page, and add `(`[/Zo](../Topic/-Zo%20\(Enhance%20Optimized%20Debugging\).md)`)` to the **Additional Options** text box.  
    ...
    >   
    >  Adding `/Zo` will disable [Edit and Continue](../VS_debugger/edit-and-continue--visual-csharp-.md).  

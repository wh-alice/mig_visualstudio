...
These examples show how to debug rendering problems in DirectX-based apps by using [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Graphics Diagnostics.  

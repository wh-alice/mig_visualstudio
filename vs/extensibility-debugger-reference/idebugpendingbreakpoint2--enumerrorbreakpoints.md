---
title: "IDebugPendingBreakpoint2::EnumErrorBreakpoints | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `bpErrorType`  
 [in] A combination of values from the [BP_ERROR_TYPE](../extensibility-debugger-reference/bp_error_type.md) enumeration that selects the type of errors to enumerate.  

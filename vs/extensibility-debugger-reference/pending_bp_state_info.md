---
title: "PENDING_BP_STATE_INFO | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
## Members  
 state  
 A value from the [PENDING_BP_STATE](../extensibility-debugger-reference/pending_bp_state.md) enumeration that specifies the state of the pending breakpoint.  
  
 flags  
 A combination of flags from the [PENDING_BP_STATE_FLAGS](../extensibility-debugger-reference/pending_bp_state_flags.md) enumeration that specifies whether the breakpoint is virtualized.  

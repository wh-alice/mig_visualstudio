...
## Members  
 BPREQI_BPLOCATION  
 Initialize/use the `bpLocation` (breakpoint location) field of the [BP_REQUEST_INFO](../extensibility-debugger-reference/bp_request_info.md) or [BP_REQUEST_INFO2](../extensibility-debugger-reference/bp_request_info2.md) structure.  
...
## Remarks  
 Passed as an argument to the [GetRequestInfo](../extensibility-debugger-reference/idebugbreakpointrequest2--getrequestinfo.md) and [BP_REQUEST_INFO](../extensibility-debugger-reference/bp_request_info.md) methods to specify which fields of the [BP_REQUEST_INFO](../extensibility-debugger-reference/bp_request_info.md) and [BP_REQUEST_INFO2](../extensibility-debugger-reference/bp_request_info2.md) structures are to be initialized.  

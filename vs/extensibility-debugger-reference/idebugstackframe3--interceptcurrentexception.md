---
title: "IDebugStackFrame3::InterceptCurrentException | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `dwFlags`  
 [in] Specifies different actions. Currently, only the [INTERCEPT_EXCEPTION_ACTION](../extensibility-debugger-reference/intercept_exception_action.md) value `IEA_INTERCEPT` is supported and must be specified.  

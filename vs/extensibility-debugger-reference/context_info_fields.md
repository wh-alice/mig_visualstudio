---
title: "CONTEXT_INFO_FIELDS | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
## Members  
 CIF_MODULEURL  
 Initialize/use the `bstrModuleUrl` field of the [CONTEXT_INFO](../extensibility-debugger-reference/context_info.md) structure.  
...
## Remarks  
 These values are passed a parameter to the [GetInfo](../extensibility-debugger-reference/idebugmemorycontext2--getinfo.md) method to indicate which fields of the [CONTEXT_INFO](../extensibility-debugger-reference/context_info.md) structure are to be initialized.  

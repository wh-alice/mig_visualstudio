---
title: "IDebugProgramProvider2::GetProviderProcessData | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `Flags`  
 [in] A combination of flags from the [PROVIDER_FLAGS](../extensibility-debugger-reference/provider_flags.md) enumeration. The following flags are typical for this call:  
...
|`PFLAG_GET_PROGRAM_NODES`|Caller is asking for a list of program nodes to be returned.|  
 ...
 `processId`  
 [in] An [AD_PROCESS_ID](../extensibility-debugger-reference/ad_process_id.md) structure holding the ID of the process that contains the program in question.  
 ...
 `pProcess`  
 [out] A [PROVIDER_PROCESS_DATA](../extensibility-debugger-reference/provider_process_data.md) structure that is filled in with the requested information.  

---
title: "PROCESS_INFO_FIELDS | hehe"
ms.custom: ""
ms.date: "10/19/2016"
...
## Members  
 PIF_FILE_NAME  
 Initialize/use the `bstrFileName` field of the [PROCESS_INFO](../extensibility-debugger-reference/process_info.md) structure.  
...
## Remarks  
 Passed to the [GetInfo](../extensibility-debugger-reference/idebugprocess2--getinfo.md) method to indicate which fields of the [PROCESS_INFO](../extensibility-debugger-reference/process_info.md) structure are to be initialized.  

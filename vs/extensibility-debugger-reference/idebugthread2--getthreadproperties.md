---
title: "IDebugThread2::GetThreadProperties | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `dwFields`  
 [in] A combination of flags from the [THREADPROPERTY_FIELDS](../extensibility-debugger-reference/threadproperty_fields.md) enumeration that determines which fields of `ptp` are to be filled in.  

---
title: "IDebugBreakpointUnboundEvent2::GetReason | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `pdwUnboundReason`  
 [out] Returns a value from the [BP_UNBOUND_REASON](../extensibility-debugger-reference/bp_unbound_reason.md) enumeration specifying the reason the breakpoint was unbound.  

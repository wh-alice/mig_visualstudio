---
title: "IDebugBreakpointRequest2::GetRequestInfo | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `dwFields`  
 [in] A combination of flags from the [BPREQI_FIELDS](../extensibility-debugger-reference/bpreqi_fields.md) enumeration that determines which fields in the `pBPRequestInfo` parameter are to be filled out.  
  
 `pBPRequestInfo`  
 [out] Specifies the [BP_REQUEST_INFO](../extensibility-debugger-reference/bp_request_info.md) structure to be filled in with the description of the breakpoint request.  

---
title: "IDebugProgram2::GetDisassemblyStream | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `dwScope`  
 [in] Specifies a value from the [DISASSEMBLY_STREAM_SCOPE](../extensibility-debugger-reference/disassembly_stream_scope.md) enumeration that defines the scope of the disassembly stream.  

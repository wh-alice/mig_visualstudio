---
title: "IDebugErrorBreakpointResolution2::GetResolutionInfo | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `dwFields`  
 [in] A combination of flags from the [BPERESI_FIELDS](../extensibility-debugger-reference/bperesi_fields.md) enumeration that determine which fields of `pErrorResolutionInfo` are to be filled out.  
  
 `pErrorResolutionInfo`  
 [in, out] The [BP_ERROR_RESOLUTION_INFO](../extensibility-debugger-reference/bp_error_resolution_info.md) structure that is filled in with the description of the breakpoint resolution.  

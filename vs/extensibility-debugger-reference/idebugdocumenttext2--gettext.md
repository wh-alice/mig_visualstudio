---
title: "IDebugDocumentText2::GetText | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `pos`  
 [in] A [TEXT_POSITION](../extensibility-debugger-reference/text_position.md) structure that indicates the location of the text to be retrieved.  

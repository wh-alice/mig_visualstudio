---
title: "IDebugDocumentContext2::GetName | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `gnType`  
 [in] A value from the [GETNAME_TYPE](../extensibility-debugger-reference/getname_type.md) enumeration that specifies the type of name to return.  

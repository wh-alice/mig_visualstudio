---
title: "IDebugBreakpointResolution2::GetResolutionInfo | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `dwFields`  
 [in] A combination of flags from the [BPRESI_FIELDS](../extensibility-debugger-reference/bpresi_fields.md) enumeration that determine which fields of the `pBPResolutionInfo` parameter are to be filled out.  
  
 `pBPResolutionInfo`  
 [out] The [BP_RESOLUTION_INFO](../extensibility-debugger-reference/bp_resolution_info.md) structure to be filled in with information about this breakpoint.  

---
title: "IDebugProgramNode2::GetHostName | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 `dwHostNameType`  
 [in] A value from the [GETHOSTNAME_TYPE](../extensibility-debugger-reference/gethostname_type.md) enumeration that specifies the type of name to return.  

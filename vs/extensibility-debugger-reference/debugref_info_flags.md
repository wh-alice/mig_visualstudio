---
title: "DEBUGREF_INFO_FLAGS | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
## Remarks  
 These flags are passed to the [EnumChildren](../extensibility-debugger-reference/idebugreference2--enumchildren.md) and [GetReferenceInfo](../extensibility-debugger-reference/idebugreference2--getreferenceinfo.md) methods to indicate which fields of the [DEBUG_REFERENCE_INFO](../extensibility-debugger-reference/debug_reference_info.md) structure are to be initialized.  

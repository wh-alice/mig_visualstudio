...
## Remarks  
 Used as the `dwState` member of the [EXCEPTION_INFO](../extensibility-debugger-reference/exception_info.md) structure to indicate the state of the exception and what can be done about it.  

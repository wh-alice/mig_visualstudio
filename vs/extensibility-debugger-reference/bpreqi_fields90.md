---
title: "BPREQI_FIELDS90 | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
#### Parameters  
 BPREQI90_BPLOCATION  
 Initialize or use the `bpLocation` (breakpoint location) field of the [BP_REQUEST_INFO](../extensibility-debugger-reference/bp_request_info.md) or [BP_REQUEST_INFO2](../extensibility-debugger-reference/bp_request_info2.md) structure.  

---
title: "BP_RESOLUTION_INFO | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
## Members  
 `dwFields`  
 A collection of flags from the [BPRESI_FIELDS](../extensibility-debugger-reference/bpresi_fields.md) enumerations that specifies which fields are filled out.  
  
 `bpResLocation`  
 The [BP_RESOLUTION_LOCATION](../extensibility-debugger-reference/bp_resolution_location.md) structure that specifies the location of the breakpoint in code or data.  

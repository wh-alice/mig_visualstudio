---
title: "METADATA_ADDRESS_LOCAL | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
## Remarks  
 ...
 `Warning:` [C++ only]  If `pLocal` is not null, then you must call `Release` on the token pointer (`addr` is a field in the [DEBUG_ADDRESS](../extensibility-debugger-reference/debug_address.md) structure):  

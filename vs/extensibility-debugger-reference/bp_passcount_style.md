---
title: "BP_PASSCOUNT_STYLE | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
## Remarks  
 Used for the `stylePassCount` member of the [BP_PASSCOUNT](../extensibility-debugger-reference/bp_passcount.md) structure that is in turn a member of the [BP_REQUEST_INFO](../extensibility-debugger-reference/bp_request_info.md) and [BP_REQUEST_INFO2](../extensibility-debugger-reference/bp_request_info2.md) structures.  

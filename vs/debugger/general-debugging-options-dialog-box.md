 ...
 **Break when exceptions cross AppDomain or managed/native boundaries**  
 ...
 3\) When code calls a function by using reflection, and the function throws an exception. See [Reflection](http://msdn.microsoft.com/en-us/Library/d1a58e7f-fb39-4d50-bf84-e3b8f9bf9775).  
 ...
 **Enable the exception assistant**  
 For managed code only. Managed exceptions open the  exception assistant dialog box.  See [Exception Assistant](http://msdn.microsoft.com/en-us/Library/992892ac-9d52-44cc-bf09-b44bfc5befeb).  
 ...
 **Enable Diagnostic Tools while debugging**  
 The **Diagnostic Tools** window appears while you are debugging. For more information, see [Debugger-integrated profiling](http://msdn.microsoft.com/en-us/Library/a1f40370-7b61-42c2-afc4-0e13eba98859).  

...
You can use the WPF Tree visualizer to explore the visual tree of a WPF object, and to view the WPF dependency properties for the objects that are contained in that tree. For more information about visual trees, see [Trees in WPF](http://msdn.microsoft.com/en-us/Library/e83f25e5-d66b-4fc7-92d2-50130c9a6649). For more information about dependency properties, see [Dependency Properties Overview](http://msdn.microsoft.com/en-us/Library/d119d00c-3afb-48d6-87a0-c4da4f83dee5).  
...
## See Also  
 ...
 [Trees in WPF](http://msdn.microsoft.com/en-us/Library/e83f25e5-d66b-4fc7-92d2-50130c9a6649)   
 [Dependency Properties Overview](http://msdn.microsoft.com/en-us/Library/d119d00c-3afb-48d6-87a0-c4da4f83dee5)
...
1.  [Edit your build definition or create a new build definition.](http://msdn.microsoft.com/en-us/Library/1c2eca2d-9a65-477e-9b23-0678ff7882ee)  
...
3.  Specify where to save the symbols (PDB) file so that your source is indexed automatically.  
     ...
     For more about symbols, see [Publish symbol data](http://msdn.microsoft.com/en-us/Library/bd6977ca-e30a-491a-a153-671d81222ce6).  
...
-   **Build**  
    ...
    -   **BuildLabel** (for TeamBuild): The build name and number. This label is also used as the name of the deployment event. For more info about build numbers, see [Use build numbers to give meaningful names to completed builds](http://msdn.microsoft.com/en-us/Library/1f302e9d-4b0a-40b5-8009-b69ca6f988c3).  

...
1.  If the local machine has Windows Firewall enabled, see [Set Up the Remote Tools on the Device](http://msdn.microsoft.com/en-us/Library/90f45630-0d26-4698-8c1f-63f85a12db9c) for instructions about how to configure the firewall for local debugging.  

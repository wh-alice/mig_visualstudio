...
#### Parameters  
 `pRetVal`  
 [out] Returns a value from the [CV_call_e Enumeration](../../debugger/debug-interface-access/cv_call_e.md) enumeration that specifies a method's calling convention.  

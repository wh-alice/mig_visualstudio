...
## Remarks  
 The [IDiaSymbol::get_isAggregated](../../debugger/debug-interface-access/idiasymbol--get_isaggregated.md) method returns `TRUE` for all symbols that are part of a split symbol.  
...
## See Also  
 ...
 [IDiaSymbol::get_isAggregated](../../debugger/debug-interface-access/idiasymbol--get_isaggregated.md)
...
6.  Delete the code that appears in the source file and replace it with the example code that appears in the section "Creating a Thread" of the topic [Creating Threads and Passing Data at Start Time](http://msdn.microsoft.com/en-us/Library/52b32222-e185-4f42-91a7-eaca65c0ab6d).  

...
> [!IMPORTANT]
>  You need administrator credentials to install [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)]. However, you don't need them to use [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] after you install it.  
...
###  <a name="BKMK_Media"></a> Using installation media  
 To install [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], in the root directory on the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] installation media, run the installation file for the edition you want:  
...
###  <a name="BKMK_Offline"></a> Creating an offline installation  layout  
 If you do not have the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] installation media, or you do not have a Visual Studio subscription,  or you do not want to install [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] by using the web installer, you can perform a "disconnected" installation by creating what is known as an offline installation layout. For more information, see the [Creating an Offline Installation of Visual Studio](../VS_Installing/creating-an-offline-installation-of-visual-studio.md) topic.  
  
##  <a name="enterprise"></a> Deploying Visual Studio in an Enterprise  
 For information about how to deploy [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] over a network, see the [Visual Studio Administrator Guide](../VS_Installing/visual-studio-administrator-guide.md).  
...
##  <a name="helpContent"></a> Installing offline Help content  
 After you install [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], you can download additional Help content so that it will be available offline.  
  
#### To install or uninstall Help content  
  
1.  On the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] menu bar, choose **Help**, **Add and Remove Help Content**.  

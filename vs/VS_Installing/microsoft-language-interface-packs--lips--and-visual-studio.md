...
1.  Click **Start**, click **Control Panel**, and then open **Regional and Language Options** (or **Region** in [!INCLUDE[win8](../dv_TeamTestALM/includes/win8_md.md)]).  
...
## Changing the Language Used for the UI Text in Visual Studio  
 When you install multiple language versions of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] on the same computer, the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] UI defaults to **Same as Microsoft Windows**. This setting indicates that [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] will display the UI text in the language that is specified as the display language for the operating system.  

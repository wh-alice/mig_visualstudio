...
|Topic|Description|  
|-----------|-----------------|  
|[How to: Install a Specific Release of Visual Studio](../VS_Installing/how-to--install-a-specific-release-of-visual-studio.md)|Describes how to install specific configurations of the current version of  [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].|  
|[How to: Create and Run an Unattended Installation of Visual Studio](../VS_Installing/how-to--create-and-run-an-unattended-installation-of-visual-studio.md)|Describes how to install [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] in unattended mode.|  
...
|[Installing Visual Studio 2015](../VS_Installing/installing-visual-studio-2015.md)|Provides instructions and  links to topics that describe how to install [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].|
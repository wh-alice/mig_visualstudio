...
You may want to locate the product key for [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] when you are working with customer support, upgrading from a trial version, or updating your own records.  

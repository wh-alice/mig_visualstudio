...
---
# unchecked_adjacent_difference
Same as [adjacent_difference](http://msdn.microsoft.com/en-us/Library/f44e205d-d480-4336-b6a6-5af60ced58e3), but allows the use of an unchecked iterator as output iterator when _SECURE_SCL=1 is defined.  `unchecked_adjacent_difference` is defined in the `stdext` namespace.  
...
## Remarks  
 See [adjacent_difference](http://msdn.microsoft.com/en-us/Library/f44e205d-d480-4336-b6a6-5af60ced58e3) for a code sample.  

...
> [!NOTE]
>  The following examples use the [Task-based Asynchronous Pattern (TAP)](http://msdn.microsoft.com/en-us/Library/8cef1fcf-6f9f-417c-b21f-3fd8bac75007) to create non-UI threads. However, the examples are also relevant to all .NET [Asynchronous Programming Patterns](http://msdn.microsoft.com/en-us/Library/4ece5c0b-f8fe-4114-9862-ac02cfe5a5d7).  

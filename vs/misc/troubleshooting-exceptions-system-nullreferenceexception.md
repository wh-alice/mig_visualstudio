...
###  <a name="BKMK_A_property_or_field_is_null"></a> A property or field is null  
 The fields and properties of a class are automatically initialized to their [default value](http://msdn.microsoft.com/en-us/Library/53a3b505-4b27-444b-b079-0eb84a97cfd8) when the class is created. The default value of a reference type is `null` (`Nothing` in Visual Basic) Calling member methods on a field or property of a parent class when the field or property value is null causes a NullReferenceException.  
...
>   
>  To reduce the memory footprint of your class and to increase its performance, consider using lazy initialization of reference-type properties. See [Lazy Initialization](http://msdn.microsoft.com/en-us/Library/56b4ae5c-4745-44ff-ad78-ffe4fcde6b9b).  

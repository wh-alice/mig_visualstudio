...
-   Add a reference to the assembly that has the coclass (most of the time the interface and coclass should be in the same assembly). See [/reference](../Topic/-reference%20\(C%23%20Compiler%20Options\).md) or [Add Reference Dialog Box](http://msdn.microsoft.com/2feb0fe2-0805-4cc9-8cba-b0315849dfb7) for information.  

---
title: "Please select more than one configuration. If you want to make changes to only one configuration, cancel out of the Multiple Configurations dialog and select that configuration from the configuration drop-down. | hehe"
ms.custom: ""
ms.date: "10/19/2016"

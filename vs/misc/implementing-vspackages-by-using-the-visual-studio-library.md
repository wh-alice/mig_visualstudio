...
```  
 ...
 For more information about COM maps, see [Implementing CComObjectRootEx](/visual-cpp/atl/implementing-ccomobjectrootex) and [COM_INTERFACE_ENTRY Macros](http://msdn.microsoft.com/en-us/Library/19dcb768-2e1f-4b8d-a618-453a01a4bd00).  

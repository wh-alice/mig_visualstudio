...
This walkthrough demonstrates how to add a user control to a tool window.  
 ...
 A user control is a collection of Windows controls bound together in one control. To add a user control to a tool window, all you really have to do is have the user control appear in the **Toolbox**. The user control that is used in this walkthrough is the clock control developed in [Walkthrough: Authoring a Composite Control with Visual C#](http://msdn.microsoft.com/en-us/Library/f88481a8-c746-4a36-9479-374ce5f2e91f).  
...
1.  Follow the steps in [Walkthrough: Authoring a Composite Control with Visual C#](http://msdn.microsoft.com/en-us/Library/f88481a8-c746-4a36-9479-374ce5f2e91f) to create the clock control. Do not create the alarm clock control.  
...
## See Also  
 [Walkthrough: Authoring a Composite Control with Visual C#](http://msdn.microsoft.com/en-us/Library/f88481a8-c746-4a36-9479-374ce5f2e91f)
...
## Tool Window Essentials  
 ...
 VSPackages are not the only way to create a tool window. Add-ins can create a tool window by using the Visual Studio Automation model. For more information, see [How to: Create and Control Tool Windows](http://msdn.microsoft.com/en-us/Library/15984015-b1a3-4368-9f17-756833cec969).  

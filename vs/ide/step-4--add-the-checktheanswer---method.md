...
1.  Add the `CheckTheAnswer()` method.  
     ...
     [!code-vb[VbExpressTutorial3Step4#8](../ide/codesnippet/VisualBasic/step-4--add-the-checktheanswer---method_1.vb)]
     [!code-cs[VbExpressTutorial3Step4#8](../ide/codesnippet/CSharp/step-4--add-the-checktheanswer---method_1.cs)]  
...
2.  Add the following code to the `if else` statement.  
     ...
     [!code-vb[VbExpressTutorial3Step4#10](../ide/codesnippet/VisualBasic/step-4--add-the-checktheanswer---method_2.vb)]
     [!code-cs[VbExpressTutorial3Step4#10](../ide/codesnippet/CSharp/step-4--add-the-checktheanswer---method_2.cs)]  

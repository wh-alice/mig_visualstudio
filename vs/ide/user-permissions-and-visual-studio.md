...
|Add-ins|Installing and using add-ins that were written by using classic COM in the IDE.|[Creating Add-ins and Wizards](http://msdn.microsoft.com/en-us/Library/c5a47c21-6668-4de3-898d-afa969317e73)|  
...
||Debugging in Zone for XAML Browser Applications (XBAP).|[WPF Host (PresentationHost.exe)](http://msdn.microsoft.com/en-us/Library/3215bfa1-722c-4ac8-a7c5-bdd02d30afbd)|  
...
||Configuring a firewall for remote debugging.|[Set Up the Remote Tools on the Device](http://msdn.microsoft.com/en-us/Library/90f45630-0d26-4698-8c1f-63f85a12db9c)|  

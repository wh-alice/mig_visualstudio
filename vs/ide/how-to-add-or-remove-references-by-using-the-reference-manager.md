...
-   A component that uses [!INCLUDE[net_v40_short](../code-quality/includes/net_v40_short_md.md)] is incompatible with a project that targets the [!INCLUDE[net_v45](../ide/includes/net_v45_md.md)].  
     ...
     When you create a new application, some projects target the [!INCLUDE[net_v45](../ide/includes/net_v45_md.md)] by default. For more information, see [.NET Framework Client Profile](http://msdn.microsoft.com/en-us/Library/f0219919-1f02-4588-8704-327a62fd91f1).  

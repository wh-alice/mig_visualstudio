 ...
 **Sign the assembly** check box  
 ...
 This option uses the Al.exe tool provided by the [!INCLUDE[winsdklong](../../deployment/includes/winsdklong_md.md)] to sign the assembly. For more information about Al.exe, see [How to: Sign an Assembly with a Strong Name](http://msdn.microsoft.com/en-us/Library/2c30799a-a826-46b4-a25d-c584027a6c67).  

 ...
 **Show Output window when build starts**  
 Automatically displays the Output Window in the IDE at the outset of solution builds. For more information, see [How to: Control the Output Window](http://msdn.microsoft.com/en-us/Library/91aebd15-8854-4a7a-9f7d-57376fb4e858). This option is enabled by default.  

---
title: "Output Element (MSBuild) | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
|Element|Description|  
|-------------|-----------------|  
|[Task](../reference/task-element--msbuild-.md)|Creates and executes an instance of an [!INCLUDE[vstecmsbuild](../extensibility-internals/includes/vstecmsbuild_md.md)] task.|  

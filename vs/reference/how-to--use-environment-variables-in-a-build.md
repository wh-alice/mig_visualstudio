---
title: "How to: Use Environment Variables in a Build | testtitle"
ms.custom: ""
ms.date: "10/24/2016"
...
## Referencing Environment Variables  
 All environment variables are available to the [!INCLUDE[vstecmsbuildengine](../reference/includes/vstecmsbuildengine_md.md)] ([!INCLUDE[vstecmsbuild](../extensibility-internals/includes/vstecmsbuild_md.md)]) project file as properties.  

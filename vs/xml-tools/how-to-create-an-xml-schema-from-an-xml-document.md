...
-   If the XML document contains an inline XML-Data Reduced (XDR) schema, the XDR schema is converted to a corresponding XML Schema.  
 ...
 For more information about the schema inference engine, see [Inferring an XML Schema](http://msdn.microsoft.com/en-us/Library/b18e7ffd-3c04-482d-9934-ba2f6a59b2c9).  

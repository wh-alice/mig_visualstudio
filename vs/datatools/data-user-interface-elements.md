...
## In This Section  
 [Data Smart Tags](http://msdn.microsoft.com/1e0a848f-c57b-47ab-b884-eaaa40726f43)  
 Provides information on some smart tag commands that are available for data.  
  
 [Add Dataset Dialog Box](http://msdn.microsoft.com/0e03c0ff-212b-4bfa-ac51-3c2adb71ead0)  
 ...
 [Advanced SQL Generation Options Dialog Box](http://msdn.microsoft.com/41420450-1ff4-4a1a-b85b-6f6901538fef)  
 ...
 [Choose a Data Source Instance Dialog Box](http://msdn.microsoft.com/51c47f06-fdc5-453e-9178-0a5a2c5c9f34)  
 Allows you to select the desired dataset from a list of datasets in your project.  
  
 [Choose a Data Source to Merge with Dialog Box](http://msdn.microsoft.com/accafff7-f6bd-481c-a121-fe8a76cd681d)  
 Allows you to select which data source to merge with when multiple data sources are available.  
  
 [Choose Key Dialog Box](http://msdn.microsoft.com/4ddbfbb7-a80a-412a-b80d-291d86376ca3)  
 ...
 [Connections Missing](http://msdn.microsoft.com/bb9b2e12-7f76-4ee5-acbb-5d20116ee044)  
 Informs you when a dataset contains a reference to a connection string that is not in application settings.  
  
 [Data Adapter Configuration Error Dialog Box](http://msdn.microsoft.com/9ce65cd2-0c7d-4f51-8685-d68be5f3009b)  
 ...
 [Data Adapter Configuration Wizard](http://msdn.microsoft.com/efff90cb-0e4c-4eb3-87dc-65dd9d418809)  
 ...
 [Data Adapter Preview Dialog Box](http://msdn.microsoft.com/1f614cd3-4530-457e-84af-00ccbaea08cc)  
 ...
 [Data Source Login Dialog Box](http://msdn.microsoft.com/6f2d9a57-53c3-4841-bd37-a3643eb68d2e)  
 Allows you to request access to a data source (typically a database) for which you have not already been authenticated.  
  
 [DataSet Tab, Toolbox](http://msdn.microsoft.com/fa5f2d6f-924d-4262-ba1b-e9e7f90e7764)  
 Displays the objects you can add to a typed dataset.  
  
 [Do you want to include the password in the connection string Dialog Box](http://msdn.microsoft.com/193696a7-5213-4396-8328-05ac2df6ee94)  
 Allows you to control whether a password is embedded into the connection string.  
  
 [Edit Key Dialog Box](http://msdn.microsoft.com/f5c80e39-3a42-4284-b222-6ca009fd9675)  
 Allows you to define and edit keys.  
  
 [Foreign Key Constraint Dialog Box](http://msdn.microsoft.com/45d15629-1f4d-40a7-8708-c9ddfebedc1e)  
 Allows you to place a foreign key constraint on one or more columns in a dataset table that is related to another table.  
  
 [Generate Dataset Dialog Box](http://msdn.microsoft.com/c0efdbaf-13b1-4ee8-ade6-f8a784126cdc)  
 ...
 [Multiple BindingSources Dialog Box](http://msdn.microsoft.com/db76f70c-4fb5-479d-9b64-a67158d48f97)  
 ...
 [Preview Data Dialog Box](http://msdn.microsoft.com/aa4f0d04-2695-4bb8-946d-54a97ae7287f)  
 Allows you to review the data returned by queries in your project.  
  
 [Preview SQL Script Dialog Box](http://msdn.microsoft.com/e9571e8b-821c-492d-9bc8-b44eba898bdd)  
 Appears as part of the [Data Adapter Configuration Wizard](http://msdn.microsoft.com/efff90cb-0e4c-4eb3-87dc-65dd9d418809) to allow you to see the SQL script the wizard will use to create stored procedures to read and write data.  
  
 [Relation Dialog Box](http://msdn.microsoft.com/ab8f4b0e-af4c-4725-a550-e2b2ebe43a02)  
 ...
 [Table Mappings Dialog Box](http://msdn.microsoft.com/fb4cec1e-f3c8-4773-b409-c2de15293fea)  
 ...
 [Unique Constraint Dialog Box](http://msdn.microsoft.com/e71a60d7-fae2-4bd0-a1e8-43aae351707d)  

...
-   Visual C# and F#--[How to: Specify Build Events (C#)](../VS_IDE/how-to--specify-build-events--csharp-.md).  
...
-   Enclose file paths in quotation marks.  
     ...
     Example (for [!INCLUDE[win8](../dv_TeamTestALM/includes/win8_md.md)]): "%ProgramFiles(x86)%\Microsoft SDKs\Windows\v8.0A\Bin\NETFX 4.0 Tools\gacutil.exe" -if "$(TargetPath)"  

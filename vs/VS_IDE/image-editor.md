...
---
# Image Editor
This document describes how to work with the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Image Editor to view and modify texture and image resources.  
...
## Getting started  
 This section describes how to add an image to your [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] project and configure it for your requirements.  
...
|Title|Description|  
|-----------|-----------------|  
|[Working with 3-D Assets for Games and Apps](../VS_IDE/working-with-3-d-assets-for-games-and-apps.md)|Provides an overview of the tools that you can use in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] to work with graphics assets such as textures and images, 3-D models, and shader effects.|  

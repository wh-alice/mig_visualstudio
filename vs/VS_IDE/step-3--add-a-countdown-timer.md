...
1.  Add an integer variable that's named **timeLeft**, just like you did in the previous procedure. Your code should look like the following.  
     ...
     [!code[VbExpressTutorial3Step3#5](../VS_IDE/codesnippet/VisualBasic/step-3--add-a-countdown-timer_1.vb)]
[!code[VbExpressTutorial3Step3#5](../VS_IDE/codesnippet/CSharp/step-3--add-a-countdown-timer_1.cs)]  
...
5.  Add the following statements to the new event handler method.  
     ...
     [!code[VbExpressTutorial3Step3#6](../VS_IDE/codesnippet/VisualBasic/step-3--add-a-countdown-timer_2.vb)]
[!code[VbExpressTutorial3Step3#6](../VS_IDE/codesnippet/CSharp/step-3--add-a-countdown-timer_2.cs)]  
    ...
    ```  
     ...
     [!code[VbExpressTutorial3Step3#24](../VS_IDE/codesnippet/VisualBasic/step-3--add-a-countdown-timer_3.vb)]
[!code[VbExpressTutorial3Step3#24](../VS_IDE/codesnippet/CSharp/step-3--add-a-countdown-timer_3.cs)]  
...
6.  Add three lines to the end of the `StartTheQuiz()` method, so the code looks like the following.  
     ...
     [!code[VbExpressTutorial3Step3#7](../VS_IDE/codesnippet/VisualBasic/step-3--add-a-countdown-timer_4.vb)]
[!code[VbExpressTutorial3Step3#7](../VS_IDE/codesnippet/CSharp/step-3--add-a-countdown-timer_4.cs)]  

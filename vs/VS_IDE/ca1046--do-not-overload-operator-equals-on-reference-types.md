...
## Example  
 ...
 [!code[FxCop.Design.RefTypesNoEqualityOp#1](../VS_IDE/codesnippet/CSharp/ca1046--do-not-overload-operator-equals-on-reference-types_1.cs)]  
  
## Example  
 The following application compares some references.  
  
 [!code[FxCop.Design.TestRefTypesNoEqualityOp#1](../VS_IDE/codesnippet/CSharp/ca1046--do-not-overload-operator-equals-on-reference-types_2.cs)]  

...
---
# Shader Designer
This document describes how to work with the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Shader Designer to create, modify, and export custom visual effects that are known as *shaders*.  
...
## Getting Started  
 This section describes how to add a DGSL shader to your [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] project and provides basic information to help you get started.  
...
### Shader Designer toolbars  
 ...
 Commands that affect the state of the Shader Designer are located on the **Shader Designer Mode** toolbar in the main [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] window. Design tools and commands are located on the **Shader Designer** toolbar on the Shader Designer design surface.  
...
|Title|Description|  
|-----------|-----------------|  
|[Working with 3-D Assets for Games and Apps](../VS_IDE/working-with-3-d-assets-for-games-and-apps.md)|Provides an overview of the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] tools that you can use to work with textures and images, 3-D models, and shader effects.|  
...
|[Model Editor](../VS_IDE/model-editor.md)|Describes how to use the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Model Editor to work with 3-D models.|
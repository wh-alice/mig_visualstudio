...
3.  To test the extension, press **CTRL+F5** or **F5**.  
     ...
     An experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] starts. In this instance, create a layer diagram. Your command or gesture extension should work in this diagram.  
...
6.  To install the extension in the main instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], or on another computer, find the **.vsix** file in **bin\\\***. Copy it to the computer where you want to install it, and then double-click it. To uninstall it, use **Extensions and Updates** on the **Tools** menu.  
...
2.  To test the feature, press CTRL+F5 or F5. An experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] opens. In this instance, create or open a layer diagram.  
  
3.  To install the VSIX in the main instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], or on another computer, find the **.vsix** file in the **bin** directory of the VSIX project. Copy it to the computer where you want to install the VSIX. Double-click the VSIX file in Windows Explorer (File Explorer in Windows 8).  

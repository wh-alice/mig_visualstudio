...
[!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Profiling Tools can collect performance data for JavaScript code that executes in an [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Web application, an arbitrary Web page, or JavaScript application by using the instrumentation profiling method.  
...
> -  
 ...
 When you specify JavaScript profiling, both the JavaScript code that executes in the browser and the [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] code that executes on the server are profiled.  
  
-   For an [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Web application, both the JavaScript code that executes in the browser and the [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] code that executes on the server are profiled.  
...
1.  In [!INCLUDE[vsPreLong](../VS_IDE/includes/vsprelong_md.md)], open the [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Web project.  
...
1.  Open [!INCLUDE[vsPreShort](../VS_IDE/includes/vspreshort_md.md)].  

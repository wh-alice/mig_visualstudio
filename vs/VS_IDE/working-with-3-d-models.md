...
You can use the Model Editor in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] to create 3-D models. You can use the models in your DirectX-based game or app.  

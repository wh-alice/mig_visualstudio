...
1.  Create a Class Library project, either in a new [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] solution, or in an existing solution.  
...
1.  Press **F5**, or on the **Debug** menu, click **Start Debugging**.  
     ...
     An experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] starts.  
  
     **Troubleshooting**: If a new [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] does not start:  
  
    -   If you have more than one project, make sure that the VSIX project is set as the Startup project of the solution.  
  
    -   In Solution Explorer, on the shortcut menu of the startup or only project, choose Properties. In the project properties editor, choose the **Debug** tab. Make sure that the string in the **Start external program** field is the full pathname of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], typically:  
  
         `C:\Program Files\Microsoft Visual Studio [version]\Common7\IDE\devenv.exe`  
  
2.  In the experimental [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], open or create a modeling project, and open or create a modeling diagram. Use a diagram that belongs to one of the types listed in the attributes of your gesture handler class.  
...
-   `DiagramDragEventArgs eventArgs`. This parameter carries the serialized form of the source object of a drag operation:  
    ...
    ```  
     ...
     You can drag elements of many different kinds onto a diagram, from different parts of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], or from the Windows desktop. Different types of element are encoded in different ways in `IDataObject`. To extract the elements from it, refer to the documentation for the appropriate type of object.  
...
##  <a name="Installing"></a> Installing and uninstalling an extension  
 You can install a [!INCLUDE[vs_current_short](../VS_debugger/includes/vs_current_short_md.md)] extension both on your own computer and on other computers.  
...
2.  Copy the **.vsix** file to the target computer on which you want to install the extension. This can be your own computer or another one.  
     ...
     The target computer must have one of the editions of [!INCLUDE[vs_current_short](../VS_debugger/includes/vs_current_short_md.md)] that you specified in **source.extension.vsixmanifest**.  

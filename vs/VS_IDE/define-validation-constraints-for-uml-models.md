...
## Applying Validation Constraints  
 ...
 Validation errors are reported in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] errors window, and you can double-click the error to select the model elements that are in error.  
...
2.  In the validation class project, add references to the following [!INCLUDE[TLA2#tla_net](../VS_IDE/includes/tla2sharptla_net_md.md)] assemblies:  
...
2.  In the experimental [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], open or create a modeling project, and open or create a modeling diagram.  
...
-   `"error string"` appears in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Error List  

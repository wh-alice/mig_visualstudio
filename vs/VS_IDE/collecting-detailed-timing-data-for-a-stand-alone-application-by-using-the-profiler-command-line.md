...
|----------|---------------------|  
|**Profile a .NET Framework application by using instrumentation**|-   [How to: Instrument a .NET Component and Collect Detailed Timing Data](../VS_IDE/b7dcc27b-45c6-4302-9552-6fa5b1e94b56.md)|  
|**Profile a C/C++ application by using instrumentation**|-   [How to: Instrument a Native Component and Collect Detailed Timing Data](../VS_IDE/36883074-9be8-4e90-a66f-7e87f21fcd30.md)|  
...
|**Profiling .NET memory allocation and garbage collection**|-   [Collecting .NET Framework Memory Data](../VS_IDE/7bce69e2-407c-4342-8516-641586968928.md)|  
...
|Task|Related Content|  
|----------|---------------------|  
|**Profiling ASP.NET applications**|-   [Collecting Detailed Timing Data Using Instrumentation](../VS_IDE/29f2fc55-aaf7-4e18-a672-8815455fba73.md)|  
|**Profiling services**|-   [Collecting Detailed Timing Data Using Instrumentation](../VS_IDE/6116e1df-ed3e-4b0d-ac7f-22f7d7ac00ea.md)|  

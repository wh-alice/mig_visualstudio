...
## Cause  
 A method passes a string literal as a parameter to a constructor or method in the [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] class library and that string should be localizable.  
...
## Example  
 ...
 [!code[FxCop.Globalization.DoNotPassLiterals#1](../VS_IDE/codesnippet/CPP/ca1303--do-not-pass-literals-as-localized-parameters_1.cpp)]
[!code[FxCop.Globalization.DoNotPassLiterals#1](../VS_IDE/codesnippet/VisualBasic/ca1303--do-not-pass-literals-as-localized-parameters_1.vb)]
[!code[FxCop.Globalization.DoNotPassLiterals#1](../VS_IDE/codesnippet/CSharp/ca1303--do-not-pass-literals-as-localized-parameters_1.cs)]  

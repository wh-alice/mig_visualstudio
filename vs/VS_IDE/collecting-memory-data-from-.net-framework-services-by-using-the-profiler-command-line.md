...
This section describes the procedures and options for collecting memory allocation and object lifetime data for a [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] service using the sampling method from the command line.  
...
|**Instrument a .NET service and collect .NET memory data**|-   [How to: Instrument a .NET Framework Service and Collect Memory Data](../VS_IDE/2fa072fc-05fe-4420-99c0-51d2ea3ac4ce.md)|  

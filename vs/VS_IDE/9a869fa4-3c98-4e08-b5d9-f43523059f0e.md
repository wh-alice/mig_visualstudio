...
This topic describes how to use [!INCLUDE[vsPreShort](../VS_IDE/includes/vspreshort_md.md)] Profiling Tools command-line tools to attach the profiler to a running .NET Framework stand-alone (client) application and collect memory data.  

...
---
# Toolbox, Components Tab
Displays components you can add to [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] and [!INCLUDE[csprcs](../VS_debugger/includes/csprcs_md.md)] designers. In addition to the [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] components that are included with [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], such as the \<xref:System.Messaging.MessageQueue> and \<xref:System.Diagnostics.EventLog> components, you can add your own or third-party components to this tab. For more information, see [How to: Manipulate Toolbox Tabs](assetId:///21285050-cadd-455a-b1f5-a2289a89c4db).  

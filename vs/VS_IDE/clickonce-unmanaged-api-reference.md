...
[!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] unmanaged public APIs from dfshim.dll.  
  
## CleanOnlineAppCache  
 Cleans or uninstalls all online applications from the [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] application cache.  
...
### Remarks  
 Calling CleanOnlineAppCache will start the [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] service if it is not already running.  

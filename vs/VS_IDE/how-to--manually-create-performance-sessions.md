...
You can manually create a performance session. You are not required to open a project in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] to do this. For more information, see [Configuring Performance Sessions](../VS_IDE/configuring-performance-sessions.md).  

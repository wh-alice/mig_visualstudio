...
## Cause  
 A field is declared `static` and `readonly` (`Shared` and `ReadOnly` in [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)]), and is initialized with a value that is computable at compile time.  
...
## Example  
 ...
 [!code[FxCop.Performance.UseLiterals#1](../VS_IDE/codesnippet/VisualBasic/ca1802--use-literals-where-appropriate_1.vb)]
[!code[FxCop.Performance.UseLiterals#1](../VS_IDE/codesnippet/CSharp/ca1802--use-literals-where-appropriate_1.cs)]
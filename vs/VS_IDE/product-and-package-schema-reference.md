...
## Example  
 The following code example demonstrates a complete product file for installing the [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)].  

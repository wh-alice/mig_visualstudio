...
You can embed a DSL diagram in a Windows Control, which appears in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] window.  
...
4.  To test the DSL, press F5 and in the experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], open a sample model file.  

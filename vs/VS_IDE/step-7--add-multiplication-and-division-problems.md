...
1.  Add four more integer variables to the form.  
     ...
     [!code[VbExpressTutorial3Step7#15](../VS_IDE/codesnippet/VisualBasic/step-7--add-multiplication-and-division-problems_1.vb)]
[!code[VbExpressTutorial3Step7#15](../VS_IDE/codesnippet/CSharp/step-7--add-multiplication-and-division-problems_1.cs)]  
...
2.  As you did before, modify the `StartTheQuiz()` method to fill in random numbers for the multiplication and division problems.  
     ...
     [!code[VbExpressTutorial3Step7#16](../VS_IDE/codesnippet/VisualBasic/step-7--add-multiplication-and-division-problems_2.vb)]
[!code[VbExpressTutorial3Step7#16](../VS_IDE/codesnippet/CSharp/step-7--add-multiplication-and-division-problems_2.cs)]  
  
3.  Modify the `CheckTheAnswer()` method so that it also checks the multiplication and division problems.  
  
     [!code[VbExpressTutorial3Step7#17](../VS_IDE/codesnippet/VisualBasic/step-7--add-multiplication-and-division-problems_3.vb)]
[!code[VbExpressTutorial3Step7#17](../VS_IDE/codesnippet/CSharp/step-7--add-multiplication-and-division-problems_3.cs)]  
...
4.  Change the last part of the timer's Tick event handler so that it fills in the correct answer when time runs out.  
     ...
     [!code[VbExpressTutorial3Step7#23](../VS_IDE/codesnippet/VisualBasic/step-7--add-multiplication-and-division-problems_4.vb)]
[!code[VbExpressTutorial3Step7#23](../VS_IDE/codesnippet/CSharp/step-7--add-multiplication-and-division-problems_4.cs)]  

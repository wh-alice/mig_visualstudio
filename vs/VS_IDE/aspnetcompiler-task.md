...
---
# AspNetCompiler Task
The `AspNetCompiler` task wraps aspnet_compiler.exe, a utility to precompile [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] applications.  
...
## Example  
 The following code example uses the `AspNetCompiler` task to precompile an [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] application.  

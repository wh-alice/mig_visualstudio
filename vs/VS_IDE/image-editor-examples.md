...
|[Using 3-D Assets in Your Game or App](../VS_IDE/using-3-d-assets-in-your-game-or-app.md)|Describes how you can use [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] to process 3-D assets when you build your project or solution so that they are ready for use in your app. Strategies for loading different kinds of assets into your app are also discussed.|  

...
1.  In [!INCLUDE[vsPreLong](../VS_IDE/includes/vsprelong_md.md)]. [!INCLUDE[vsUltLong](../VS_IDE/includes/vsultlong_md.md)], or [!INCLUDE[vsPro](../VS_IDE/includes/vspro_md.md)] open the solution.  

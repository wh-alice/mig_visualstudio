...
The Event Tracing for Windows (ETW) report lists the ETW events that are recorded in a performance session of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Profiling Tools. ETW data is collected in a binary (.etl) file. For more information about this report, see [Event Tracing for Windows (ETW) Report](../VS_IDE/event-tracing-for-windows--etw--report.md).  
  
> [!NOTE]
>  You cannot display ETW reports in the interface for [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
  
-   For information about how to collect ETW data by using the interface for [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], see [How to: Collect Event Tracing for Windows (ETW) Data](../VS_IDE/how-to--collect-event-tracing-for-windows--etw--data.md).  

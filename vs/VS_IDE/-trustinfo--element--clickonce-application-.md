...
-   `Level`  
     ...
     [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] applications will only install with a value of `asInvoker`. Installing with any other value will fail.  
...
## Examples  
 The following three code examples illustrate `trustInfo` elements for the default named security zones—Internet, LocalIntranet, and FullTrust—for use in a [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] deployment's application manifest.  

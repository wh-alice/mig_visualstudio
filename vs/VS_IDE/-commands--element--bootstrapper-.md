...
---
# &lt;Commands&gt; Element (Bootstrapper)
The `Commands` element implements tests described by the elements underneath the `InstallChecks` element, and declares which package the [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] bootstrapper should install if the test fails.  

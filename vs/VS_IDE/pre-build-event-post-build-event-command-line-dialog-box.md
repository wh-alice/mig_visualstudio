...
You can type pre- or post-build events for the [Build Events Page, Project Designer (C#)](../VS_IDE/build-events-page--project-designer--csharp-.md) directly in the edit box, or you can select pre- and post-build macros from a list of available macros.  

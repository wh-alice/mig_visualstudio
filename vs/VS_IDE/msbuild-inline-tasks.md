...
MSBuild tasks are typically created by compiling a class that implements the \<xref:Microsoft.Build.Framework.ITask> interface. For more information, see [Tasks](../VS_IDE/msbuild-tasks.md).  

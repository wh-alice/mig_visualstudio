...
1.  Open the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] project for the application in which you want to read a DSL model.  
...
## References  
 You have to add these references to your [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] application project:  

...
|Propagate changes to resources such as other [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] extensions outside the store.|See [Event Handlers Propagate Changes Outside the Model](../VS_IDE/event-handlers-propagate-changes-outside-the-model.md).|  

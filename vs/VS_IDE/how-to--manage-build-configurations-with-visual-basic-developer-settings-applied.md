...
By default, all advanced build configuration options are hidden with [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] Developer settings applied. This topic explains how to manually enable these settings.  
  
## Enabling advanced build configurations  
 By default, the [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] Developer settings hide the option to open the **Configuration Manager** dialog box and the **Configuration** and **Platform** lists in the [Project Designer](assetId:///898dd854-c98d-430c-ba1b-a913ce3c73d7).  

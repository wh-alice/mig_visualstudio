...
In Visual Studio, you can specify the version or profile of the .NET Framework that you want your project to target. For an application to run on another computer, the Framework version that the application targets must be compatible with the Framework version that is installed on the computer.  
 ...
 This section contains topics that describe how to target specific versions of the [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] in your projects.  
...
## In This Section  
 ...
 Details how to specify a particular [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] for your Visual Basic, Visual C# or Visual F# project.  
...
## Related Sections  
 ...
 Describes the **Target Framework** control in the Project Designer for [!INCLUDE[csprcs](../VS_debugger/includes/csprcs_md.md)] projects.  
  
 [Application Page, Project Designer (Visual Basic)](../VS_IDE/application-page--project-designer--visual-basic-.md)  
 Describes the **Target Framework** control in the Project Designer for [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] projects.  

...
-   Visual Studio Enterprise  
 ...
 When you create a new coded UI test, the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] testing framework generates code for the test by default in a \<xref:Microsoft.VisualStudio.TestTools.UITest.Common.UIMap.UIMap> class. For more information about how to record coded UI tests, see [Creating Coded UI Tests](../VS_IDE/use-ui-automation-to-test-your-code.md#VerifyingCodeUsingCUITCreate) and [Anatomy of a Coded UI Test](../VS_IDE/anatomy-of-a-coded-ui-test.md).  
...
4.  Choose **Add**.  
     ...
     The [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] window minimizes and the **Coded UI Test Builder** dialog box is displayed.  

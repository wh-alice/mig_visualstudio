...
|[Export diagrams as images](../VS_IDE/export-diagrams-as-images.md)|**Save your model and diagrams** so that you can share them with other users, including those who do not use [!INCLUDE[vsUltShort](../VS_IDE/includes/vsultshort_md.md)].|  

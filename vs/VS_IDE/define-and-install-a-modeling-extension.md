...
-   A [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Integration Extension (VSIX) project. This generates a file that acts as an installer for the components of your extension.  
...
1.  In the [!INCLUDE[vs_current_short](../VS_debugger/includes/vs_current_short_md.md)] **Debug** menu, choose **Start Debugging**.  
  
     The project builds, and a new instance of [!INCLUDE[vs_current_short](../VS_debugger/includes/vs_current_short_md.md)] starts in Experimental mode.  

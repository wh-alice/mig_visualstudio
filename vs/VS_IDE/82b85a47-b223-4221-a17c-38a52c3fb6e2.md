...
2.  Use the following code to download the appropriate satellite assembly and start your application.  
     ...
     [!code[ClickOnce.SatelliteAssemblies#1](../VS_IDE/codesnippet/CSharp/82b85a47-b223-4221-a17c-38a52c3fb6e2_1.cs)]  
...
3.  Add the following imports to the beginning of the ApplicationEvents.VB file.  
     ...
     [!code[ClickOnce.SatelliteAssembliesVB#1](../VS_IDE/codesnippet/VisualBasic/82b85a47-b223-4221-a17c-38a52c3fb6e2_2.vb)]  
  
4.  Add the following code to the `MyApplication` class.  
  
     [!code[ClickOnce.SatelliteAssembliesVB#2](../VS_IDE/codesnippet/VisualBasic/82b85a47-b223-4221-a17c-38a52c3fb6e2_3.vb)]  

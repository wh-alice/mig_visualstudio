...
1.  On the **File** menu of [!INCLUDE[vs_current_short](../VS_debugger/includes/vs_current_short_md.md)], point to **New** and then click **File**.  

...
|[CA1415: Declare P/Invokes correctly](../VS_IDE/ca1415--declare-p-invokes-correctly.md)|This rule looks for platform invoke method declarations that target [!INCLUDE[TLA2#tla_win32](../Token/TLA2%23tla_win32_md.md)] functions that have a pointer to an OVERLAPPED structure parameter and the corresponding managed parameter is not a pointer to a \<xref:System.Threading.NativeOverlapped?displayProperty=fullName> structure.|
...
|[CA1404: Call GetLastError immediately after P/Invoke](../VS_IDE/ca1404--call-getlasterror-immediately-after-p-invoke.md)|A call is made to the Marshal.GetLastWin32Error method or the equivalent [!INCLUDE[TLA2#tla_win32](../VS_IDE/includes/tla2sharptla_win32_md.md)] GetLastError function, and the immediately previous call is not to a platform invoke method.|  
...
|[CA1415: Declare P/Invokes correctly](../VS_IDE/ca1415--declare-p-invokes-correctly.md)|This rule looks for platform invoke method declarations that target [!INCLUDE[TLA2#tla_win32](../VS_IDE/includes/tla2sharptla_win32_md.md)] functions that have a pointer to an OVERLAPPED structure parameter and the corresponding managed parameter is not a pointer to a \<xref:System.Threading.NativeOverlapped?displayProperty=fullName> structure.|
...
You can add handlers for drag-and-drop events to your DSL, so that users can drag items onto your diagram from other diagrams or from other parts of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)]. You can also add handlers for events such as double-clicks. Together, drag-and-drop and double-click handlers are known as *gesture handlers*.  
...
1.  Make the source DSL accessible by [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Model Bus:  

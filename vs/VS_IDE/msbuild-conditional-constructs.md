...
---
# MSBuild Conditional Constructs
[!INCLUDE[vstecmsbuild](../VS_IDE/includes/vstecmsbuild_md.md)] provides a mechanism for either/or processing with the [Choose](../VS_IDE/choose-element--msbuild-.md), [When](../VS_IDE/when-element--msbuild-.md), and [Otherwise](../VS_IDE/otherwise-element--msbuild-.md) elements.  

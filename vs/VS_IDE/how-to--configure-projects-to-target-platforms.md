...
[!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] enables you to set up your applications to target different platforms, including 64-bit platforms. For more information on 64-bit platform support in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], see [64-bit Applications](../Topic/64-bit%20Applications.md).  
  
## Targeting Platforms with the Configuration Manager  
 The **Configuration Manager** provides a way for you to quickly add a new platform to target with your project. If you select one of the platforms included with [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], the properties for your project are modified to build your project for the selected platform.  
...
-   For [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] projects, see [/platform (Visual Basic)](../Topic/-platform%20\(Visual%20Basic\).md).  
  
-   For [!INCLUDE[csprcs](../VS_debugger/includes/csprcs_md.md)] projects, see [Build Page, Project Designer (C#)](../VS_IDE/build-page--project-designer--csharp-.md).  
  
-   For [!INCLUDE[vcprvc](../VS_debugger/includes/vcprvc_md.md)] projects, see [/clr (Common Language Runtime Compilation)](../Topic/-clr%20\(Common%20Language%20Runtime%20Compilation\).md).  

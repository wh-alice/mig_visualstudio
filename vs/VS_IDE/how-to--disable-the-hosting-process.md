...
1.  Open an executable project in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)]. Projects that do not produce executables (for example, class library or service projects) do not have this option.  
...
-   The time needed to begin debugging [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] applications increases.  

...
-   A [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] solution named CppDemo.  
...
4.  Copy the following code and paste it into the **Bug.cpp** file in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] editor.  
...
8.  Copy the following code and paste it into the Bug.h file in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] editor.  
...
4.  Copy the following code and paste it into the **annotations.h** file in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] editor.  
...
8.  Copy the following code and paste it into the **annotations.cpp** file in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] editor.  

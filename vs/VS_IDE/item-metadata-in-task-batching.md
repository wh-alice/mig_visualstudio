...
[!INCLUDE[vstecmsbuild](../VS_IDE/includes/vstecmsbuild_md.md)] has the ability to divide item lists into different categories, or batches, based on item metadata, and run a task one time with each batch. It can be confusing to understand exactly what items are being passed with which batch. This topic covers the following common scenarios that involve batching.  
...
-   Filtering item lists  
 ...
 For more information on batching with [!INCLUDE[vstecmsbuild](../VS_IDE/includes/vstecmsbuild_md.md)], see [Batching](../VS_IDE/msbuild-batching.md).  

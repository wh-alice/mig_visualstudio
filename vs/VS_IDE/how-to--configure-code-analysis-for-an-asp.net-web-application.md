...
In [!INCLUDE[vsPreShort](../VS_IDE/includes/vspreshort_md.md)] and [!INCLUDE[vsUltShort](../VS_IDE/includes/vsultshort_md.md)] you can select from a list of Code Analysis *rule sets* to apply to [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Web application. The default rule set is the Microsoft Mininimum Recommended Rules. You can select another rule set to apply to the Web site.  

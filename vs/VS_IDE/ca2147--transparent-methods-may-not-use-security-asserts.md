...
## Rule Description  
 ...
 The [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] 2.0 introduced a feature named *transparency*. Individual methods, fields, interfaces, classes, and types can be either transparent or critical.  
...
## Example  
 ...
 [!code[FxCop.Security.CA2147.TransparentMethodsMustNotUseSecurityAsserts#1](../VS_IDE/codesnippet/CSharp/ca2147--transparent-methods-may-not-use-security-asserts_1.cs)]  
...
## Example  
 ...
 [!code[FxCop.Security.SecurityTransparentCode2#1](../VS_IDE/codesnippet/CSharp/ca2147--transparent-methods-may-not-use-security-asserts_2.cs)]  

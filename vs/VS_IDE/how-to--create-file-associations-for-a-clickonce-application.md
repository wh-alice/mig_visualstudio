...
1.  Create a [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] application normally, or use your existing [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] application.  

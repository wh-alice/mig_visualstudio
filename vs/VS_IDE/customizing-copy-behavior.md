...
In a domain-specific language (DSL) created with the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Visualization and Modeling SDK, you can alter what happens when the user copies and pastes elements.  

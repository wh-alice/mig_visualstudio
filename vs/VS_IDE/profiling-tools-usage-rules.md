...
|||  
|-|-|  
|[DA0002: VSPerfCorProf.dll is missing](../VS_IDE/da0002--vsperfcorprof.dll-is-missing.md)|Command line profiling might contain incomplete data for [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] binaries. This might be caused by not setting the correct environment variables.|  
...
|[DA0029: Unsupported CLR Version](../VS_IDE/da0029--unsupported-clr-version.md)|The profiled binary is using a version of [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] that is not supported by the profiler. The profiler reports cannot resolve symbol names.|  

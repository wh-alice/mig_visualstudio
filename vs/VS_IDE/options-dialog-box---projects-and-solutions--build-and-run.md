 ...
 **On Run, when projects are out of date**  
 > [!NOTE]
>  This list applies to [!INCLUDE[vcprvc](../VS_debugger/includes/vcprvc_md.md)] projects only.  
...
> [!NOTE]
>  This option applies to [!INCLUDE[vcprvc](../VS_debugger/includes/vcprvc_md.md)] projects only.  

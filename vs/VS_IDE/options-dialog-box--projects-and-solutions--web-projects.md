...
Sets the Web server that Web projects will use for development within [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)]. To access this dialog box, click **Tools Options**. Expand **Projects and Solutions** and then click **Web Projects**.  

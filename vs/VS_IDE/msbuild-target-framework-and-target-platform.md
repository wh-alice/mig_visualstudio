...
## Target Framework and Profile  
 A target framework is the particular version of the [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] that your project is built to run on. Specification of a target framework is required because it enables compiler features and assembly references that are exclusive to that version of the framework.  
  
 Currently, the following versions of the .NET Framework are available for use:  
  
-   The [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] 2.0 (included in Visual Studio 2005)  
  
-   The [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] 3.0 (included in [!INCLUDE[wiprlhext](../dv_TeamTestALM/includes/wiprlhext_md.md)])  
  
-   The [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] 3.5 (included in [!INCLUDE[vs_orcas_long](../dv_TeamTestALM/includes/vs_orcas_long_md.md)])  
  
-   The [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] 4 (included in Visual Studio 2010)  
  
-   The [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] 4.5 (included in [!INCLUDE[vs_dev11_long](../dv_TeamTestALM/includes/vs_dev11_long_md.md)])  
  
-   The [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] 4.5.1 (included in [!INCLUDE[vs_dev12](../VS_IDE/includes/vs_dev12_md.md)])  
  
-   The [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] 4.5.2  
  
-   The [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] 4.6 (included in [!INCLUDE[vs_dev14](../VS_IDE/includes/vs_dev14_md.md)])  

...
---
# Model Editor
This document describes how to work with the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Model Editor to view, create, and modify 3-D models.  
...
## Getting started  
 This section describes how to add a 3-D model to your [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] project and provides the basic information you need to get started.  
...
### Axis orientation  
 [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] supports every orientation of the 3-D axis, and loads axis orientation information from model file formats that support it. If no axis orientation is specified, [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] uses the right-handed coordinate system by default. The **axis indicator** shows the current axis orientation in the lower-right corner of the design surface. On the **axis indicator**, red represents the x-axis, green represents the y-axis, and blue represents the z-axis.  
...
### Model Editor toolbars  
 ...
 Commands that affect the state of the Model Editor are located on the **Model Editor Mode** toolbar in the main [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] window. Modeling tools and scripted commands are located on the **Model Editor** toolbar on the Model Editor design surface.  
...
|**Real-Time Rendering Mode**|When real-time rendering is enabled, [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] redraws the design surface, even when no user action is performed. This mode is useful when you work with shaders that change over time.|  
...
|Title|Description|  
|-----------|-----------------|  
|[Working with 3-D Assets for Games and Apps](../VS_IDE/working-with-3-d-assets-for-games-and-apps.md)|Provides an overview of the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] tools that you can use to work with graphics assets such as textures and images, 3-D models, and shader effects.|  
|[Image Editor](../VS_IDE/image-editor.md)|Describes how to use the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Image Editor to work with textures and images.|  
|[Shader Designer](../VS_IDE/shader-designer.md)|Describes how to use the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Shader Designer to work with shaders.|
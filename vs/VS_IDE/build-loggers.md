...
## Registering for Events  
 ...
 [!code[msbuild_SimpleConsoleLogger#2](../VS_IDE/codesnippet/CSharp/build-loggers_1.cs)]  
...
## Responding to Events  
 ...
 [!code[msbuild_SimpleConsoleLogger#3](../VS_IDE/codesnippet/CSharp/build-loggers_2.cs)]  
...
## Responding to Logger Verbosity Values  
 ...
 [!code[msbuild_SimpleConsoleLogger#4](../VS_IDE/codesnippet/CSharp/build-loggers_3.cs)]  
  
## Specifying a Logger  
 Once the logger is compiled into an assembly, you need to tell [!INCLUDE[vstecmsbuild](../VS_IDE/includes/vstecmsbuild_md.md)] to use that logger during builds. This is done using the **/logger** switch with MSBuild.exe. For more information on the switches available for MSBuild.exe, see [Command-Line Reference](../VS_IDE/msbuild-command-line-reference.md).  
  
 The following command line builds the project `MyProject.csproj` and uses the logger class implemented in `SimpleLogger.dll`. The **/nologo** switch hides the banner and copyright message and the **/noconsolelogger** switch disables the default [!INCLUDE[vstecmsbuild](../VS_IDE/includes/vstecmsbuild_md.md)] console logger.  
...
### Code  
 [!code[msbuild_SimpleConsoleLogger#1](../VS_IDE/codesnippet/CSharp/build-loggers_4.cs)]  
...
### Code  
 [!code[msbuild_BasicLogger#1](../VS_IDE/codesnippet/CSharp/build-loggers_5.cs)]  

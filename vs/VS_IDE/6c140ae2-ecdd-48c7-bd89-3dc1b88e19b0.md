...
This topic describes how to use [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Profiling Tools command-line tools to collect detailed timing data for a dynamically compiled [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] application by using the instrumentation profiling method.  
...
3.  Start the [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Web application in the typical way.  
...
## Ending the Profiling Session  
 To end a profiling session, close the target [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Web application, reset IIS to stop the profiled process, and then shut down the profiler.  

...
5.  Build and run the project.  
     ...
     A new instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] will start in experimental mode.  
  
6.  Create or open a UML class diagram in the experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  

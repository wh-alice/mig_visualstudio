...
When you first open a Domain-Specific Language Tools (DSL Tools) solution in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], the user interface will resemble the following picture.  

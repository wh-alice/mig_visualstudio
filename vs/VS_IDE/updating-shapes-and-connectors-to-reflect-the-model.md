...
In a domain-specific language in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], you can make the appearance of a shape reflect the state of the underlying model.  

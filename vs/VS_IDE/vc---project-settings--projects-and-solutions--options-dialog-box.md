...
This dialog box lets you define [!INCLUDE[vcprvc](../VS_debugger/includes/vcprvc_md.md)] project settings related to build logging and supporting file types.  
 ...
 **Yes**  
 Lists environment variables in the build log file. This option specifies to echo all environment variables, during builds of [!INCLUDE[vcprvc](../VS_debugger/includes/vcprvc_md.md)] projects, into the build log file.  

...
## Control blocks  
 Control blocks are sections of program code that are used to transform the templates. The default language is C#, but to use [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)], you can write this directive at the beginning of the file:  
 ...
 **Edit the model file in a diagram or form.** [!INCLUDE[dsl](../VS_IDE/includes/dsl_md.md)] provides tools that let you edit a model as a diagram or Windows form. This makes it easier to discuss the model with users of the generated application. [!INCLUDE[dsl](../VS_IDE/includes/dsl_md.md)] also creates a set of strongly-typed classes that reflect the structure of the model. For more information, see [Generating Code from a Domain-Specific Language](../VS_IDE/generating-code-from-a-domain-specific-language.md).  

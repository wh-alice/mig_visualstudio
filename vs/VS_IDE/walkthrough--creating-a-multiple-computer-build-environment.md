...
-   [!INCLUDE[win8_appname_long](../VS_debugger/includes/win8_appname_long_md.md)] apps. To build [!INCLUDE[win8_appname_long](../VS_debugger/includes/win8_appname_long_md.md)] apps, you must install Visual Studio on the build computer.  
...
##  <a name="BuildingProjects"></a> Building projects  
 You can use Team Foundation Build to build [!INCLUDE[vs_dev11_long](../dv_TeamTestALM/includes/vs_dev11_long_md.md)] projects and solutions, or you can build them on the command line. When you use Team Foundation Build to build projects, it invokes the MSBuild executable that corresponds to the system architecture.  On the command line, you can use either 32-bit MSBuild or 64-bit MSBuild, and you can choose the architecture of MSBuild by setting the PATH environment variable or by directly invoking the architecture-specific MSBuild executable.  
...
> [!NOTE]
>  To build [!INCLUDE[vs_dev11_long](../dv_TeamTestALM/includes/vs_dev11_long_md.md)] projects, you must use the "v110" Platform Toolset. If you don't want to edit the [!INCLUDE[vs_dev11_long](../dv_TeamTestALM/includes/vs_dev11_long_md.md)] project files, you can set the Platform Toolset by using this command-line argument:  
>   

...
You can use the **Performance Wizard** to collect performance data for an [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Web application. You can profile a Web application that is open in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], or you can profile an [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Web site that is located on your local computer and not open in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] IDE.  
...
1.  Open the [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Web project in [!INCLUDE[vsPreShort](../VS_IDE/includes/vspreshort_md.md)] or [!INCLUDE[vsUltShort](../VS_IDE/includes/vsultshort_md.md)].  
...
8.  A performance session is created for the [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] application, and the Web site is started in the browser. Exercise the functionality that you want to profile, and then close the browser.  
  
     The profiler generates the data file and displays the Summary view of the data in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] main window.  
  
### To profile a Web site without opening a project in Visual Studio  
  
1.  Open [!INCLUDE[vsPreShort](../VS_IDE/includes/vspreshort_md.md)] or [!INCLUDE[vsUltShort](../VS_IDE/includes/vsultshort_md.md)].  

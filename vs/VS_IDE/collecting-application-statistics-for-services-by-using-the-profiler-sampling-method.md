...
|----------|---------------------|  
|**Attach the profiler to a .NET service**|-   [How to: Attach the Profiler to a .NET Service to Collect Application Statistics](../VS_IDE/a0046c47-26c8-4bec-96a0-81da05e5104a.md)|  
|**Add tier-interaction data**|-   [Collecting tier interaction data](../VS_IDE/adding-tier-interaction-data-from-the-command-line.md)|  
|**Attach the profiler to a C/C++ service**|-   [How to: Attach the Profiler to a Native Service to Collect Application Statistics](../VS_IDE/f783817f-77a0-4eb8-985b-ec3b77eadc42.md)|  

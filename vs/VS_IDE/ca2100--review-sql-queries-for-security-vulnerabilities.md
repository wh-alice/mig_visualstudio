...
-   Validate the user input for both type and content before you build the command string.  
 ...
 The following [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] types implement the \<xref:System.Data.IDbCommand.CommandText*> property or provide constructors that set the property by using a string argument.  
...
## Example  
 ...
 [!code[FxCop.Security.ReviewSqlQueries#1](../VS_IDE/codesnippet/VisualBasic/ca2100--review-sql-queries-for-security-vulnerabilities_1.vb)]
[!code[FxCop.Security.ReviewSqlQueries#1](../VS_IDE/codesnippet/CSharp/ca2100--review-sql-queries-for-security-vulnerabilities_1.cs)]
[!code[FxCop.Security.ReviewSqlQueries#1](../VS_IDE/codesnippet/CPP/ca2100--review-sql-queries-for-security-vulnerabilities_1.cpp)]  

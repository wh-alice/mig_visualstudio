...
The extension uses classes that are derived from \<xref:Microsoft.VisualStudio.TestTools.UITest.Extension.UITechnologyElement> and represent the Worksheet control and Cell control in [!INCLUDE[ofprexcel](../dv_TeamTestALM/includes/ofprexcel_md.md)].  

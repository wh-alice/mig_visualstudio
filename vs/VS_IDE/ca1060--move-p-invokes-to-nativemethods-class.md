...
## Rule Description  
 Platform Invocation methods, such as those that are marked by using the \<xref:System.Runtime.InteropServices.DllImportAttribute?displayProperty=fullName> attribute, or methods that are defined by using the `Declare` keyword in [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)], access unmanaged code. These methods should be in one of the following classes:  
...
## Example  
 ...
 [!code[FxCop.Design.DllImportNativeMethods#1](../VS_IDE/codesnippet/VisualBasic/ca1060--move-p-invokes-to-nativemethods-class_1.vb)]
[!code[FxCop.Design.DllImportNativeMethods#1](../VS_IDE/codesnippet/CSharp/ca1060--move-p-invokes-to-nativemethods-class_1.cs)]  
...
### Code  
 [!code[FxCop.Design.NativeMethods#1](../VS_IDE/codesnippet/CSharp/ca1060--move-p-invokes-to-nativemethods-class_2.cs)]
[!code[FxCop.Design.NativeMethods#1](../VS_IDE/codesnippet/VisualBasic/ca1060--move-p-invokes-to-nativemethods-class_2.vb)]  
...
### Code  
 [!code[FxCop.Design.NativeMethodsSafe#1](../VS_IDE/codesnippet/VisualBasic/ca1060--move-p-invokes-to-nativemethods-class_3.vb)]
[!code[FxCop.Design.NativeMethodsSafe#1](../VS_IDE/codesnippet/CSharp/ca1060--move-p-invokes-to-nativemethods-class_3.cs)]  
...
### Code  
 [!code[FxCop.Design.NativeMethodsUnsafe#1](../VS_IDE/codesnippet/VisualBasic/ca1060--move-p-invokes-to-nativemethods-class_4.vb)]
[!code[FxCop.Design.NativeMethodsUnsafe#1](../VS_IDE/codesnippet/CSharp/ca1060--move-p-invokes-to-nativemethods-class_4.cs)]  

...
## Elements and Attributes  
 The `compatibleFrameworks` element is required for deployment manifests that target the [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] runtime provided by [!INCLUDE[net_v40_short](../VS_debugger/includes/net_v40_short_md.md)] or later. The `compatibleFrameworks` element contains one or more `framework` elements that specify the .NET Framework versions on which this application can run. The [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] runtime will run the application on the first available `framework` in this list.  
...
## Example  
 The following code example shows a `compatibleFrameworks` element in a [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] deployment manifest. This deployment can run on the [!INCLUDE[net_client_v40_long](../VS_IDE/includes/net_client_v40_long_md.md)]. It can also run on the [!INCLUDE[net_v40_short](../VS_debugger/includes/net_v40_short_md.md)] because it is a superset of the [!INCLUDE[net_client_v40_long](../VS_IDE/includes/net_client_v40_long_md.md)].  

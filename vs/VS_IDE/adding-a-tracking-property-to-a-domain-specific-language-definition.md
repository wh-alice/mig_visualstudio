...
|[!INCLUDE[dsl](../VS_IDE/includes/dsl_md.md)]|[http://go.microsoft.com/fwlink/?LinkID=185581](http://go.microsoft.com/fwlink/?LinkID=185581)|  
...
## Testing the Language  
 The next step is to build and run the DSL designer in a new instance of [!INCLUDE[vs_current_short](../VS_debugger/includes/vs_current_short_md.md)] so that you can verify that the tracking property is working correctly.  
...
2.  On the **Debug** menu, click **Start Debugging**.  
     ...
     The experimental build of [!INCLUDE[vs_current_short](../VS_debugger/includes/vs_current_short_md.md)] opens the **Debugging** solution, which contains an empty test file.  

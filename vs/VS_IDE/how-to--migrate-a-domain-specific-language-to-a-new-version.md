...
You can migrate projects that define and use domain-specific language to [!INCLUDE[vs2010](../dv_TeamTestALM/includes/vs2010_md.md)] from the version of [!INCLUDE[dsl](../VS_IDE/includes/dsl_md.md)] that was distributed with [!INCLUDE[vs_orcas_long](../dv_TeamTestALM/includes/vs_orcas_long_md.md)].  
  
 A migration tool is provided as part of [!INCLUDE[vssdk_current_long](../VS_IDE/includes/vssdk_current_long_md.md)]. The tool converts [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] projects and solutions that use or define DSL Tools.  
  
 You must run the migration tool explicitly: it is not launched automatically when you open a solution in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)]. The tool and detailed guidance document can be found at this path:  
  
 **%Program Files%\Microsoft Visual Studio 2010 SDK\VisualStudioIntegration\Tools\DSLTools\DslProjectsMigrationTool.exe**  
  
## Before you Migrate your DSL Projects  
 The migration tool modifies [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] project files (**.csproj**) and solution files (**.sln**).  

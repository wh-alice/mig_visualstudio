...
## Testing and Deployment  
 To test any of the extensions in this topic, build and run the solution. An experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] opens. In this instance, open a DSL solution. Edit the DslDefinition diagram. The extension behavior can be seen.  
  
 To deploy the extensions to the main [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], and to other computers, follow these steps:  
...
2.  Copy this file to the target computer, and then in Windows Explorer (or File Explorer), double-click it.  
     ...
     The [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Extension Manager opens to confirm that the extension has been installed.  
  
 To uninstall the extension, follow these steps:  
  
1.  in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], on the **Tools** menu, click **Extension Manager**.  

...
## Installing an Extension on a Team Foundation Build Server  
 [!INCLUDE[esprbuild](../dv_TeamTestALM/includes/esprbuild_md.md)] servers do not normally have Visual Studio installed, and so you cannot install the VSIX by double-clicking it. The installation of [!INCLUDE[esprbuild](../dv_TeamTestALM/includes/esprbuild_md.md)] includes some components that allow a VSIX extension to run, but you must install the extension manually.  
  
#### To install your layer extension on a [!INCLUDE[esprbuild](../dv_TeamTestALM/includes/esprbuild_md.md)] Server  
  
1.  Copy the **.vsix** files from your development computer to the [!INCLUDE[esprbuild](../dv_TeamTestALM/includes/esprbuild_md.md)] computer.  
    ...
    -   To install only for the network service that runs [!INCLUDE[esprbuild](../dv_TeamTestALM/includes/esprbuild_md.md)]:  
  
         %WinDir%\ServiceProfiles\NetworkService\AppData\Local\Microsoft\VisualStudio\\[version]\Extensions\Microsoft  
  
    -   If you have configured [!INCLUDE[esprbuild](../dv_TeamTestALM/includes/esprbuild_md.md)] to run in interactive mode as a particular user, you can install just for that user:  
...
3.  Restart [!INCLUDE[esprbuild](../dv_TeamTestALM/includes/esprbuild_md.md)].
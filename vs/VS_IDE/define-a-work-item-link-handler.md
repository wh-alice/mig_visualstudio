...
### Project References  
 Add the following [!INCLUDE[TLA2#tla_net](../VS_IDE/includes/tla2sharptla_net_md.md)] assemblies to your project references:  
...
### Import the Work Item Namespace  
 In your [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] project **References**, add references to the following assemblies:  
...
1.  Press **F5**, or on the **Debug** menu, choose **Start Debugging**.  
     ...
     **Troubleshooting**: If a new [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] does not start, ensure that the VSIX project is set as the Startup project of the solution.  

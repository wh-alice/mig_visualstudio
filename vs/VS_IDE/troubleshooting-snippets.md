...
-   The XML in the snippet file may be corrupt. The **XML Editor** in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] can locate problems in the XML structure.  
  
-   The snippet file may not conform to the snippet schema. The **XML Editor** in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] can locate problems in the XML structure.  

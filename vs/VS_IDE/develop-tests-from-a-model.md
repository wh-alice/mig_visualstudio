...
#### Linking tests to use cases  
 If you are using [!INCLUDE[TCMlong](../VS_IDE/includes/tcmlong_md.md)] to design and run your tests, you can organize your tests under requirement, use case, or user story work items. You can link these work items to use cases in your model. This enables you to quickly trace requirements changes to the tests, and helps you track the progress of each use case.  
  
###### To link tests to a use case  
  
1.  In [!INCLUDE[TCMlong](../VS_IDE/includes/tcmlong_md.md)], create a requirement and base a test suite on it. To learn how to do that, see [Testing the application](../dv_TeamTestALM/test-apps-early-and-often.md).  
  
     The requirement that you create is a work item in [!INCLUDE[vstsTfsShort](../dv_TeamTestALM/includes/vststfsshort_md.md)]. It might be a User Story, Requirement, or Use Case work item, depending on the process template that your project uses with [!INCLUDE[esprfound](../dv_TeamTestALM/includes/esprfound_md.md)]. For more information, see [Track work using Visual Studio Team Services or Team Foundation Server](../Topic/Track%20work%20using%20VSTS%20or%20TFS.md).  
...
### Tests for Business Rules  
 ...
 You can link tests to a business rule by linking the comment to a requirement or user story work item, which you can link to a test suite in [!INCLUDE[TCMlong](../VS_IDE/includes/tcmlong_md.md)]. For more information, see [Attaching Test Cases to Model Elements](#Attaching).  
...
##  <a name="Attaching"></a> Attaching Test Cases to Model Elements  
 If your project uses [!INCLUDE[TCMlong](../VS_IDE/includes/tcmlong_md.md)], you can link tests to the elements in your model. This lets you quickly find the tests affected by a change in the requirements, and helps you track the extent to which a requirement has been realized.  

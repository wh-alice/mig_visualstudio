...
This internal class extends the \<xref:Microsoft.VisualStudio.TestTools.UITest.Common.UITestActionFilter> class and represents a filter for test actions on a [!INCLUDE[ofprexcel](../dv_TeamTestALM/includes/ofprexcel_md.md)] element.  

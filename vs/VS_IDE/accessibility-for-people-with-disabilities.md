...
Microsoft is committed to making its products and services easier for everyone to use. The following topics provide information about the features, products, and services that make Microsoft [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] more accessible for people with disabilities.  

...
## Access to the Model in Extensions  
 In [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] extensions defined as MEF Components, you can declare properties that import information from the context in which the extension runs.  
...
|Microsoft.VisualStudio.Shell .SVsServiceProvider<br /><br /> (in Microsoft.VisualStudio.Shell.Immutable.[version].dll)|The host [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)]. From there you can access files, projects and other aspects.|[Open a UML model by using the Visual Studio API](../VS_IDE/open-a-uml-model-by-using-the-visual-studio-api.md)|  
...
-   Use [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] model bus to create links between elements in different models. For more information, see [Integrate UML models with other models and tools](../VS_IDE/integrate-uml-models-with-other-models-and-tools.md).  
  
-   Load a modeling project and diagrams in read-only mode without making it visible in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] user interface. For more information, see [Read a UML model in program code](../VS_IDE/read-a-uml-model-in-program-code.md).  
  
-   Open a modeling project and its diagrams in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], and then access the contents. For more information, see [Open a UML model by using the Visual Studio API](../VS_IDE/open-a-uml-model-by-using-the-visual-studio-api.md).  

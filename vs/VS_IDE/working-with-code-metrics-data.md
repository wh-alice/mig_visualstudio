...
##  <a name="BKMK_Creating_a_Work_Item_Based_on_Code_Metric_Results"></a> Creating a Work Item Based on Code Metric Results  
 You can create a [!INCLUDE[esprfound](../dv_TeamTestALM/includes/esprfound_md.md)] work item that is based on results in the **Code Metric Results** window. When the work item is created, [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] automatically enters a title in the **Title** field and code metrics data under the **History** tab.  

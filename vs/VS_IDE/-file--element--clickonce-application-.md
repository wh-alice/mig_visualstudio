...
## comClass  
 The `comClass` element is an optional child of the `file` element, but is required if the [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] application contains a COM component it intends to deploy using registration-free COM. The element has the following attributes.  
...
## comInterfaceExternalProxyStub  
 The `comInterfaceExternalProxyStub` element is an optional child of the `file` element, but may be required if the [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] application contains a COM component it intends to deploy using registration-free COM. The element contains the following attributes.  
...
## comInterfaceProxyStub  
 The `comInterfaceProxyStub` element is an optional child of the `file` element, but may be required if the [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] application contains a COM component it intends to deploy using registration-free COM. The element contains the following attributes.  
...
|Attribute|Description|  
|---------------|-----------------|  
|`Algorithm`|The algorithm used to calculate the digest for this file. Currently the only value used by [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] is `urn:schemas-microsoft-com:HashTransforms.Identity`.|  
...
|Attribute|Description|  
|---------------|-----------------|  
|`Algorithm`|The algorithm used to calculate the digest for this file. Currently the only value used by [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] is `http://www.w3.org/2000/09/xmldsig#sha1`.|  
...
## Example  
 The following code example illustrates `file` elements in an application manifest for an application deployed using [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)].  

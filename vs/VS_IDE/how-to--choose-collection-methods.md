...
The [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Profiling Tools support three methods of collecting performance data: sampling, instrumentation, and concurrency. You can also use either the sampling or instrumentation method to collect .NET memory allocation and lifetime data.  
...
|**.NET Memory Allocation**|Collects [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] memory allocation data by using the sampling profiling method.|  
...
5.  Click **Collect .NET object allocation information** to collect the size and number of [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)] object allocations.  

...
---
# Target Element (MSBuild)
Contains a set of tasks for [!INCLUDE[vstecmsbuild](../VS_IDE/includes/vstecmsbuild_md.md)] to execute sequentially.  
...
|Element|Description|  
|-------------|-----------------|  
|[Task](../VS_IDE/task-element--msbuild-.md)|Creates and executes an instance of an [!INCLUDE[vstecmsbuild](../VS_IDE/includes/vstecmsbuild_md.md)] task. There may be zero or more tasks in a target.|  

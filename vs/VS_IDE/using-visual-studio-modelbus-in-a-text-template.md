...
If you write text templates that read a model that contains [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] ModelBus references, you might want to resolve the references to access the target models. In that case, you have to adapt the text templates and the referenced domain-specific languages (DSLs):  
...
1.  If the target DSL solution does not have a **ModelBusAdapter** project, create one by using the Modelbus Extension wizard:  
    ...
    1.  Download and install the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] ModelBus Extension, if you have not already done this. For more information, see [Visualization and Modeling SDK](http://go.microsoft.com/fwlink/?LinkID=185579).  
...
11. Verify that the DSL is working by pressing  F5. In the experimental project, open `Sample.provider`. Close the experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
...
1.  In the MBConsumer solution, press CTRL+F5. An experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] opens in the **MBConsumer\Debugging** project.  
...
5.  Save the file.  
     ...
     (Do not yet close the experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].)  
...
1.  In the experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], open a sample text template file. Set its content as follows.  
...
1.  Close the experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], if it is running.  
...
4.  In the experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], open `Debugging\Sample.consume`.  

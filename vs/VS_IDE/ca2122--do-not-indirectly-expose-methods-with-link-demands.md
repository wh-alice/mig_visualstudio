...
## Example  
 ...
 [!code[FxCop.Security.UnsecuredDoNotCall#1](../VS_IDE/codesnippet/CSharp/ca2122--do-not-indirectly-expose-methods-with-link-demands_1.cs)]  
  
## Example  
 The following application calls the unsecured library member.  
  
 [!code[FxCop.Security.TestUnsecuredDoNot1#1](../VS_IDE/codesnippet/CSharp/ca2122--do-not-indirectly-expose-methods-with-link-demands_2.cs)]  

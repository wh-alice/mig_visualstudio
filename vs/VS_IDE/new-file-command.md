...
## Switches  
 ...
 For example, to create a new [!INCLUDE[vcprvc](../VS_debugger/includes/vcprvc_md.md)] source file, you would enter the following for the /t:`templatename` argument.  

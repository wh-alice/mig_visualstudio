...
## How to Fix Violations  
 To fix a violation of this rule, remove or use the local variable. Note that the C# compiler that is included with [!INCLUDE[dnprdnlong](../VS_debugger/includes/dnprdnlong_md.md)] removes unused local variables when the `optimize` option is enabled.  
...
## Example  
 ...
 [!code[FxCop.Performance.UnusedLocals#1](../VS_IDE/codesnippet/VisualBasic/ca1804--remove-unused-locals_1.vb)]
[!code[FxCop.Performance.UnusedLocals#1](../VS_IDE/codesnippet/CSharp/ca1804--remove-unused-locals_1.cs)]  

...
|Warning|Description|  
|-------------|-----------------|  
|[DA0001: Use StringBuilder for concatenations](../VS_IDE/da0001--use-stringbuilder-for-concatenations.md)|Calls to System.String.Concat are a significant proportion of the profiling data. Consider using the \<xref:System.Text.StringBuilder> class to construct strings from multiple segments.|  

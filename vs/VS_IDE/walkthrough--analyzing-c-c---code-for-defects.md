...
-   [!INCLUDE[vsPreLong](../VS_IDE/includes/vsprelong_md.md)] or [!INCLUDE[vsUltLong](../VS_IDE/includes/vsultlong_md.md)].  
...
1.  Open the Demo solution in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
...
1.  On the **View** menu, click **Error List**.  
     ...
     Depending on the developer profile that you chose in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], you might have to point to **Other Windows** on the **View** menu, and then click **Error List**.  

...
This section describes the procedures and options for collecting detailed performance data for an [!INCLUDE[vstecasp](../dv_TeamTestALM/includes/vstecasp_md.md)] Web application by using the **VSPerfCmd** command line tool and the instrumentation method.  
...
|----------|---------------------|  
|**Profile statically compiled binaries**|-   [How to: Instrument a Statically Compiled ASP.NET Application and Collect Detailed Timing Data](../VS_IDE/b260ce68-76e6-4c3b-8062-3c00bd5cf7b8.md)|  
|**Profile dynamically compiled binaries**|-   [How to: Instrument a Dynamically Compiled ASP.NET Application and Collect Detailed Timing Data](../VS_IDE/6c140ae2-ecdd-48c7-bd89-3dc1b88e19b0.md)|  
...
|**Profile services**|-   [Collecting Detailed Timing Data Using Instrumentation](../VS_IDE/6116e1df-ed3e-4b0d-ac7f-22f7d7ac00ea.md)|  

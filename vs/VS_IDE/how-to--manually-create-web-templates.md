...
3.  Create an XML file and save it by using a .vstemplate file name extension, in the same directory as your project. Do not add it to the project in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
...
8.  Put the .zip template file in the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] project template directory. By default, this directory is \My Documents\Visual Studio *Version*\My Exported Templates\\.  

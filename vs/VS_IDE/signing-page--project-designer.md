 ...
 **Sign the assembly** check box  
 ...
 This option uses the Al.exe tool provided by the [!INCLUDE[winsdklong](../VS_IDE/includes/winsdklong_md.md)] to sign the assembly. For more information about Al.exe, see [How to: Sign an Assembly with a Strong Name](../Topic/How%20to:%20Sign%20an%20Assembly%20with%20a%20Strong%20Name.md).  

...
|Visual Studio Visualization and Modeling SDK|[http://go.microsoft.com/fwlink/?LinkID=186128](http://go.microsoft.com/fwlink/?LinkID=186128)|  
 ...
 To create a new domain-specific language, you create a new [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] solution using the Domain-Specific Language project template.  
...
### Test the Solution  
 ...
 To test the solution, press F5 or CTRL+F5. A new instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] opens in experimental mode.  
  
 In the new instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], in Solution Explorer, open the Sample file. It opens as a diagram, with a toolbox.  
  
 If you run a solution that you have created from the **Minimal Language** template, your experimental [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] will resemble the following example:  
  
 ![](../VS_IDE/media/dsl_min.png "DSL_min")  
  
 Experiment with the tools. Create elements and connect them.  
  
 Close the experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
...
2.  **Build and run the DSL.** Press F5 or CTRL+F5 to run a new instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] in experimental mode. In the experimental instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], open or create a file that has the file name extension of your DSL.  
...
|The toolbox of my DSL does not appear, but I have not changed the assembly name.<br /><br /> Or, a message box appears reporting the failure to load an extension.|Reset the experimental instance, and rebuild your solution.<br /><br /> 1.  At the Windows Start menu, under **All Programs**, expand [!INCLUDE[vssdk_current_long](../VS_IDE/includes/vssdk_current_long_md.md)], then **Tools**, and then click **Reset the Microsoft Visual Studio Experimental Instance**.<br />2.  On the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)]**Build** menu, click **Rebuild Solution**.|  

...
-   Install Mage.exe and MageUI.exe.  
     ...
     Mage.exe and MageUI.exe are part of the [!INCLUDE[winsdklong](../VS_IDE/includes/winsdklong_md.md)]. You must either have the [!INCLUDE[winsdkshort](../VS_debugger/includes/winsdkshort_md.md)] installed or the version of the [!INCLUDE[winsdkshort](../VS_debugger/includes/winsdkshort_md.md)] included with Visual Studio. For more information, see [Windows SDK](http://go.microsoft.com/fwlink/?LinkId=158044) on MSDN.  
...
1.  Create a directory where you will store your [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] deployment files.  
...
4.  Open the [!INCLUDE[winsdkshort](../VS_debugger/includes/winsdkshort_md.md)] or Visual Studio command prompt and change to the version subdirectory.  

...
## Example  
 The following code example specifies that the Microsoft Installer is installed with the [!INCLUDE[dnprdnshort](../VS_debugger/includes/dnprdnshort_md.md)], and therefore will not need a separate installation.  

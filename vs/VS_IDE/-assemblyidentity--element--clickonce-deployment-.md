...
Identifies the primary assembly of the [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] application.  
...
## Example  
 The following code example illustrates an `assemblyIdentity` element in a [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] deployment manifest. This code example is part of a larger example provided for the [ClickOnce Deployment Manifest](../VS_IDE/clickonce-deployment-manifest.md) topic.  

...
|Package Guid|The guid for the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] package generated for this DSL.|\<none>|  
|Package Namespace|The namespace for the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] package generated for this DSL.|\<none>|  
|Product Name|The name of the product that will be registered for the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] package generated for this DSL.|\<none>|  

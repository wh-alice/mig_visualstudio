 ...
 **Visual Studio editions**  
 ...
 Tier interaction profiling data can be collected using [!INCLUDE[vsUltLong](../VS_IDE/includes/vsultlong_md.md)], [!INCLUDE[vsPreLong](../VS_IDE/includes/vsprelong_md.md)], or [!INCLUDE[vs_pro_current_short](../dv_TeamTestALM/includes/vs_pro_current_short_md.md)]. However, tier interaction profiling data can be viewed only in [!INCLUDE[vsUltLong](../VS_IDE/includes/vsultlong_md.md)] and [!INCLUDE[vsPreLong](../VS_IDE/includes/vsprelong_md.md)].  
 ...
 **TIP reports**  
 ...
 Tier interaction data can only be viewed in the [!INCLUDE[vsUltLong](../VS_IDE/includes/vsultlong_md.md)] or [!INCLUDE[vsPreLong](../VS_IDE/includes/vsprelong_md.md)] IDE. File based tier interaction reports through [VSPerfReport](../VS_IDE/vsperfreport.md) are not available.  

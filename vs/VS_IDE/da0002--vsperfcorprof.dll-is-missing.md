...
## How to Fix Violations  
 When you are profiling managed applications by using the command-line tools in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] Profiling Tools, run the [VSPerfCLREnv](../VS_IDE/vsperfclrenv.md) command-line tool before you start collecting data.
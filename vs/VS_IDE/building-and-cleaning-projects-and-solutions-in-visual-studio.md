...
1.  Choose a [!INCLUDE[vcprvc](../VS_debugger/includes/vcprvc_md.md)] project, and then, on the menu bar, choose **Build**, **Project Only**, and one of the following commands:  
    ...
    -   **Link Only** *ProjectName*  
     ...
     These commands apply only to the [!INCLUDE[vcprvc](../VS_debugger/includes/vcprvc_md.md)] project that you chose, without building, rebuilding, cleaning, or linking any project dependencies or solution files. Depending on your version of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], the **Project Only** submenu might contain more commands.  

...
You can use the Image Editor in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] to create and modify textures and images. The Image Editor supports rich texture and image formats like those that are used in DirectX app development.  

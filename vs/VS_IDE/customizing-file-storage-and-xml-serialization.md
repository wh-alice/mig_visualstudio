...
When the user saves an instance, or *model*, of a domain-specific language (DSL) in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)], an XML file is created or updated. The file can be reloaded to recreate the model in the Store.  

...
1.  Create or open a project in [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  
...
6.  Copy and paste the .vstemplate file back to the .zip file located in the ..\Users\\*username*\Documents\Visual Studio *Version*\Templates\ItemTemplates\ folder.  
 ...
 You can now add an item based on this template to a [!INCLUDE[win8_appname_long](../VS_debugger/includes/win8_appname_long_md.md)] project by using the **Add New Item** dialog box.  

...
### Description  
 A method in the following example manipulates an integer that violates this rule. [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] requires the **Remove** integer overflow option to be disabled for this to fire.  
  
### Code  
 [!code[FxCop.Usage.OperationOverflow#1](../VS_IDE/codesnippet/VisualBasic/ca2233--operations-should-not-overflow_1.vb)]
[!code[FxCop.Usage.OperationOverflow#1](../VS_IDE/codesnippet/CSharp/ca2233--operations-should-not-overflow_1.cs)]  
...
### Code  
 [!code[FxCop.Usage.OperationOverflowFixed#1](../VS_IDE/codesnippet/CSharp/ca2233--operations-should-not-overflow_2.cs)]
[!code[FxCop.Usage.OperationOverflowFixed#1](../VS_IDE/codesnippet/VisualBasic/ca2233--operations-should-not-overflow_2.vb)]  
...
### Description  
 ...
 Note that checked blocks are not supported in [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)].  
  
### Code  
 [!code[FxCop.Usage.OperationOverflowChecked#1](../VS_IDE/codesnippet/CSharp/ca2233--operations-should-not-overflow_3.cs)]  

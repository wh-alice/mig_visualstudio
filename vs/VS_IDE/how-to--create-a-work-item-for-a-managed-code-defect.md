...
You can use the work item tracking feature to log work item from within [!INCLUDE[vsPreLong](../VS_IDE/includes/vsprelong_md.md)]. To use this feature, your project must be part of Team Project in [!INCLUDE[esprfound](../dv_TeamTestALM/includes/esprfound_md.md)].  

...
|`Sources`|Optional \<xref:Microsoft.Build.Framework.ITaskItem>`[]` parameter.<br /><br /> Specifies one or more [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] source files.|  
|`TargetCompactFramework`|Optional `Boolean` parameter.<br /><br /> If `true`, the task targets the [!INCLUDE[Compact](../VS_IDE/includes/compact_md.md)]. This switch corresponds to the [/netcf](../Topic/-netcf.md) switch of the vbc.exe compiler.|  
...
## Example  
 The following example compiles a [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] project.  

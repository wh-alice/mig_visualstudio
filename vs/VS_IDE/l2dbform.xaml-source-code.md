...
## Overall UI Structure  
 ...
 The client area is contained within a \<xref:System.Windows.Controls.StackPanel> that is given a light blue background. This panel contains four \<xref:System.Windows.Controls.DockPanel> UI sections separated by \<xref:System.Windows.Controls.Separator> bars. The purpose of these sections is described in the **Remarks** in the [previous topic](../VS_IDE/walkthrough--linqtoxmldatabinding-example.md).  

...
|[CA1504: Review misleading field names](../VS_IDE/ca1504--review-misleading-field-names.md)|The name of an instance field starts with "s_", or the name of a static (Shared in [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)]) field starts with "m_".|  

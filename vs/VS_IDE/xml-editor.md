...
---
# XML Editor
The XML Editor is based on the [!INCLUDE[msCoName](../VS_IDE/includes/msconame_md.md)] Visual Studio Text Editor and includes additional support for the XML languages. The XML Editor includes the following features:  

...
|[/DebugExe (devenv.exe)](../VS_IDE/-debugexe--devenv.exe-.md)|Loads a [!INCLUDE[vcprvc](../VS_debugger/includes/vcprvc_md.md)] executable under the control of the debugger. This switch is not available for [!INCLUDE[vbprvb](../VS_debugger/includes/vbprvb_md.md)] or [!INCLUDE[csprcs](../VS_debugger/includes/csprcs_md.md)] executables. For more information, see [Automatically start a process in the debugger](../VS_debugger/debug-multiple-processes.md#BKMK_Automatically_start_an_process_in_the_debugger).|  
...
|[/Log (devenv.exe)](../VS_IDE/-log--devenv.exe-.md)|Starts [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] and logs all activity to the log file.|  
...
|[/UseEnv (devenv.exe)](../VS_IDE/-useenv--devenv.exe-.md)|Causes the IDE to use PATH, INCLUDE, and LIB environment variables for [!INCLUDE[vcprvc](../VS_debugger/includes/vcprvc_md.md)] compilation instead of the settings specified in the VC++ Directories section of **Projects** options in the **Options** dialog box. For more information, see [Setting the Path and Environment Variables for Command-Line Builds](../Topic/Setting%20the%20Path%20and%20Environment%20Variables%20for%20Command-Line%20Builds.md)|  
...
|[/SafeMode (devenv.exe)](../VS_IDE/-safemode--devenv.exe-.md)|Starts [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] in safe mode, and loads only the default environment and services, and shipped versions of third-party packages.|  
...
|[/Updateconfiguration (devenv.exe)](../VS_IDE/-updateconfiguration--devenv.exe-.md)|Notifies [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] to merge the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] packages on the system and check the MEF cache for any changes.|  
|[/Upgrade (devenv.exe)](../VS_IDE/-upgrade--devenv.exe-.md)|Upgrades the specified solution file and all its project files, or the specified project file, to the current [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] formats for these files.|  

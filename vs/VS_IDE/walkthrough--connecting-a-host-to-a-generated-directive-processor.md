...
-   Using [!INCLUDE[dsl](../VS_IDE/includes/dsl_md.md)] to generate a directive processor that is based on a domain model.  
...
3.  On the **Debug** menu, click **Start Debugging**.  
     ...
     A second instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] opens.  
...
5.  Close the second instance of [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)].  

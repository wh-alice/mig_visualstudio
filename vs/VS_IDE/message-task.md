...
## Remarks  
 The `Message` task allows [!INCLUDE[vstecmsbuild](../VS_IDE/includes/vstecmsbuild_md.md)] projects to issue messages to loggers at different steps in the build process.  

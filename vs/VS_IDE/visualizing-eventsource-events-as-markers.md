...
The Concurrency Visualizer can display EventSource events as markers, and you can control how the markers are displayed. To view the EventSource markers, register the ETW provider GUID by using the [Advanced Settings](../VS_IDE/advanced-settings-dialog-box--concurrency-visualizer-.md) dialog box. The Concurrency Visualizer has default conventions to represent EventSource events as [Flag Markers](../VS_IDE/flag-markers.md), [Span Markers](../VS_IDE/span-markers.md), and [Message Markers](../VS_IDE/message-markers.md). You can customize how EventSource events are displayed by adding custom fields to the events. For more information about markers, see [Concurrency Visualizer Markers](../VS_IDE/concurrency-visualizer-markers.md). For more information about EventSource events, see \<xref:System.Diagnostics.Tracing>.  

...
Identifies the application deployed in a [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] deployment.  
...
### Description  
 The following code example illustrates an `assemblyIdentity` element in a [!INCLUDE[ndptecclick](../VS_IDE/includes/ndptecclick_md.md)] application manifest. This code example is part of a larger example provided in [ClickOnce Application Manifest](../VS_IDE/clickonce-application-manifest.md).  

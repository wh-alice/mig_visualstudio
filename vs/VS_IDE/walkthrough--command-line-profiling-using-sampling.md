...
-   [!INCLUDE[vsPreLong](../VS_IDE/includes/vsprelong_md.md)], [!INCLUDE[vsUltLong](../VS_IDE/includes/vsultlong_md.md)], or [!INCLUDE[vsPro](../VS_IDE/includes/vspro_md.md)]  
  
-   Intermediate understanding of [!INCLUDE[csharp_current_short](../VS_IDE/includes/csharp_current_short_md.md)]  
...
11. Profiling data is stored in the.vsp file Analyze the results by using one of the following methods:  
    ...
    -   Generate a comma-separated value (.csv) file by using the command-line tool VSPerfReport.exe. To generate reports for use outside the [!INCLUDE[vsprvs](../dv_TeamTestALM/includes/vsprvs_md.md)] IDE use the following command:  

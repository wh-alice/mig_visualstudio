...
## Remarks  
 ...
 The DE specifies how this message is to be handled by following the conventions of the Win32 function `MessageBox` (see [AfxMessageBox](http://msdn.microsoft.com/en-us/Library/d66d0328-cdcc-48f6-96a4-badf089099c8) for details).  

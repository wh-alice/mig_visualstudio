...
> [!NOTE]
>  [MageUI.exe](http://msdn.microsoft.com/en-us/Library/f9e130a6-8117-49c4-839c-c988f641dc14) does not support the `compatibleFrameworks` element when saving an application manifest that has already been signed with a certificate using [MageUI.exe](http://msdn.microsoft.com/en-us/Library/f9e130a6-8117-49c4-839c-c988f641dc14). Instead, you must use [Mage.exe](http://msdn.microsoft.com/en-us/Library/77dfe576-2962-407e-af13-82255df725a1).  

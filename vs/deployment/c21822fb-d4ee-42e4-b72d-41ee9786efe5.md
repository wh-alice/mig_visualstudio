---
title: "Walkthrough: Manually Deploying a ClickOnce Application that Does Not Require Re-Signing and that Preserves Branding Information | testtitle"
ms.custom: ""
ms.date: "10/20/2016"
...
1.  Open a Visual Studio command prompt or a [!INCLUDE[winsdkshort](../debug-interface-access/includes/winsdkshort_md.md)] command prompt, and change to the directory in which you will store your [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] files.  
...
1.  Open a Visual Studio command prompt or a [!INCLUDE[winsdkshort](../debug-interface-access/includes/winsdkshort_md.md)] command prompt, and navigate to the directory in which you will store your [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] files.  

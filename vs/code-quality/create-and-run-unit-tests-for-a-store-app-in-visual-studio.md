---
title: "Create and run unit tests for a Store app in Visual Studio | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
## In this section  
 [Unit test C# code](../code-quality/unit-testing-visual-csharp-code-in-a-store-app.md)  
  
 [Unit testing a C++ DLL](../code-quality/unit-testing-a-visual-c---dll-for-store-apps.md)  
  
 [Run unit tests in Test Explorer](../code-quality/run-unit-tests-for-store-apps-in-visual-studio.md)
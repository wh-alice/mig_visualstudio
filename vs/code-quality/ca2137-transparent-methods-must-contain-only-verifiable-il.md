...
## Rule Description  
 ...
 To be certain that your code contains only verifiable MSIL, run [Peverify.exe (PEVerify Tool)](http://msdn.microsoft.com/en-us/Library/f4f46f9e-8d08-4e66-a94b-0c69c9b0bbfa) on your assembly. Run PEVerify with the **/transparent** option which limits the output to only unverifiable transparent methods which would cause an error. If the /transparent option is not used, PEVerify also verifies critical methods that are allowed to contain unverifiable code.  

...
```  
 ...
 `c` would be sign-extended to a signed `int` with a value of -37, which is outside the valid range for [isspace](http://msdn.microsoft.com/en-us/Library/3ac254c4-92aa-4238-882a-3a3fb576cdf5).  

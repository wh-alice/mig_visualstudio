---
title: "Sample Excel Communicator Interface | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
## IExcelUICommunication Interface  
 This interface defines the communication points between the `CodedUIExtension`, which runs in the Coded UI Test process, and the `ExcelCodedUIAddIn`, which runs in the [!INCLUDE[ofprexcel](../code-quality/includes/ofprexcel_md.md)] process.  
...
## See Also  
 ...
 [Sample Excel Add-In for Coded UI Testing](../code-quality/sample-excel-add-in-for-coded-ui-testing.md)   
 [Sample Coded UI Test Extension for Excel](../code-quality/sample-coded-ui-test-extension-for-excel.md)
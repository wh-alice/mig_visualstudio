---
title: "Analyzing Coded UI Tests Using Coded UI Test Logs | testtitle"
ms.custom: ""
ms.date: "10/14/2016"
...
4.  Choose the **Output** link in the Test Explorer results.  
     ...
     ![Output link in the Test Explorer](../code-quality/media/cuit_htmlactionlog1.png "CUIT_HTMLActionLog1")  
  
     This displays the output for the test which will include a link to the action log.  
  
     ![Results and output links from coded UI test](../code-quality/media/cuit_htmlactionlog2.png "CUIT_HTMLActionLog2")  
  
5.  Choose the UITestActionLog.html link.  
  
     The log is displayed in your web browser.  
  
     ![Coded UI test log file](../code-quality/media/cuit_htmlactionlog3.png "CUIT_HTMLActionLog3")  

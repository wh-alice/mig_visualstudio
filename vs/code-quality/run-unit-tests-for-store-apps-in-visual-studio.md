---
title: "Run unit tests for Store apps in Visual Studio | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
>   
>  For more information, see [Unit Test Your Code](../code-quality/unit-test-your-code.md) in the MSDN Library.  
...
|||  
|-|-|  
|![Test Explorer group button](../code-quality/media/ute_groupby_btn.png "UTE_GroupBy_btn")|To group your tests by the time it takes to execute them, open the **Group By** list and choose **Duration**. Choose **Test Outcome** to switch to the original grouping.|  

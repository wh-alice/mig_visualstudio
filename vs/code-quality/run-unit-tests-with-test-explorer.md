---
title: "Run unit tests with Test Explorer | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
|||  
|-|-|  
|![Run after build](../code-quality/media/ute_runafterbuild_btn.png "UTE_RunAfterBuild_btn")|To run your unit tests after each local build, choose **Test** on the standard menu, and then choose **Run Tests After Build** on the Test Explorer toolbar.|  
...
###  <a name="BKMK_View_test_details"></a> View test details  
 ...
 ![Test execution details](../code-quality/media/ute_testdetails.png "UTE_TestDetails")  
...
###  <a name="BKMK_Grouping_the_test_list"></a> Grouping the test list  
 To change the way that tests are organized, choose the down arrow next to the **Group By** button ![Test Explorer group button](../code-quality/media/ute_groupby_btn.png "UTE_GroupBy_btn") and select a new grouping criteria.  
  
 ![Group tests by category in Test Explorer](../code-quality/media/ute_groupbycategory.png "UTE_GroupByCategory")  
...
3.  Enter the filter value between the quotation marks.  
 ...
 ![Filter tests in Test Explorer](../code-quality/media/ute_filtertestlist.png "UTE_FilterTestList")  
...
##  <a name="BKMK_Create_custom_playlists"></a> Create custom playlists  
 ...
 ![Choose a playlist](../code-quality/media/ute_playlist.png "UTE_Playlist")  
...
2.  Choose one of the following commands from the sub-menu:  
 ...
 For more information, see [Using Code Coverage to Determine How Much Code is being Tested](../code-quality/using-code-coverage-to-determine-how-much-code-is-being-tested.md).  
...
## See Also  
 ...
 [Run a unit test as a 64-bit process](../code-quality/run-a-unit-test-as-a-64-bit-process.md)
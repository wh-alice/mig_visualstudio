---
title: "Troubleshooting Code Coverage | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
### Custom .runsettings file with bad syntax  
 ...
 Explanation  
 You can run your unit tests with a custom .runsettings file to configure code coverage options. The options allow you to include or exclude files. For more information, see [Customizing Code Coverage Analysis](../code-quality/customizing-code-coverage-analysis.md).  
...
### Custom .runsettings file with incorrect exclusions  
 ...
 Make sure the DataCollectors node specifies Code Coverage. Compare it with the sample in [Customizing Code Coverage Analysis](../code-quality/customizing-code-coverage-analysis.md).  

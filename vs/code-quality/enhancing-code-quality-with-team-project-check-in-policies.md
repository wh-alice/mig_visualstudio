...
|----------|------------------------|  
|**Create and use check-in policies:** You create check-in policies by using the Team Project Settings of [!INCLUDE[esprscc](../code-quality/includes/esprscc_md.md)].|[Set and Enforce Quality Gates](http://msdn.microsoft.com/en-us/Library/bdc5666e-6cf0-45b2-a0a1-133c3f61e852)|  

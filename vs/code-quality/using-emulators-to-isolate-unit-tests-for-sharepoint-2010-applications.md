---
title: "Using emulators to isolate unit tests for Sharepoint 2010 applications | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
The Microsoft.SharePoint.Emulators package provides a set of libraries that help you to create isolated unit tests for Microsoft SharePoint 2010 applications. Emulators use [shims](../code-quality/using-shims-to-isolate-your-application-from-other-assemblies-for-unit-testing.md) from the [Microsoft Fakes](../code-quality/isolating-code-under-test-with-microsoft-fakes.md) isolation framework to create lightweight in-memory objects that mimic the most common objects and methods of the SharePoint API. When a SharePoint method is not emulated, or when you want to change the default behavior of an emulator, you can create Fakes shims to provide the results that you want.  
...
-   Microsoft SharePoint Emulators NuGet package  
 ...
 You should also be familiar with the [basics of unit testing in Visual Studio](../code-quality/unit-test-basics.md) and some knowledge of [Microsoft Fakes](../code-quality/isolating-code-under-test-with-microsoft-fakes.md).  
...
##  <a name="BKMK_The_AppointmentsWebPart_example"></a> The AppointmentsWebPart example  
 ...
 ![Appointments Web Part](../code-quality/media/ut_emulators_appointmentswebpart.png "UT_EMULATORS_AppointmentsWebPart")  
...
3.  Search the **Online** category for `Microsoft.SharePoint.Emulators`, and then choose **Install**.  
 ...
 ![Sharepoint Emulators NuGet package](../code-quality/media/ut_emulators_nuget.png "UT_EMULATORS_Nuget")  
...
```  
 ...
 ![Emulator execution flow](../code-quality/media/ut_emulators_flowchart.png "UT_EMULATORS_FlowChart")  
...
2.  Rebuild the test project at least once after you have installed the Microsoft SharePoint Emulators package and if you have edited the Microsoft.SharePoint.Fakes file. Building the project creates and populates a **FakesAssembly** folder in your on-disk project root folder.  
     ...
     ![FakesAssembly folder](../code-quality/media/ut_emulators_fakesassemblyfolder.png "UT_EMULATORS_FakesAssemblyFolder")  

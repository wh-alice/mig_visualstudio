---
title: "Writing Unit tests for C-C++ with the Microsoft Unit Testing Framework for C++ | hehe"
ms.custom: ""
ms.date: "10/20/2016"
...
1.  On the **File** menu, choose **New**, **Project**.  
     ...
     ![Creating a C&#43;&#43; Unit Test Project](../code-quality/media/utecpp01.png "UteCpp01")  
  
2.  In the new project, inspect **unittest1.cpp**  
  
     ![Test project with TEST&#95;CLASS and TEST&#95;METHOD](../code-quality/media/utecpp2.png "UteCpp2")  
...
3.  Verify that the tests run in Test Explorer:  
    ...
    2.  On the **Test** menu, choose **Run** , **All Tests**.  
         ...
         ![Unit Test Explorer with one passed test](../code-quality/media/utecpp04.png "UteCpp04")  
...
1.  Create a **Visual C++** project by using the **Win32 Project** template.  
     ...
     ![Creating a C&#43;&#43; Win32 project](../code-quality/media/utecpp05.png "UteCpp05")  
...
2.  Select **DLL** and **Export Symbols** in the Win32 Application Wizard.  
     ...
     ![C&#43;&#43; project wizard set for DLL and Export Symbols](../code-quality/media/utecpp06.png "UteCpp06")  
  
3.  Declare an exported function in the principal .h file:  
  
     ![New DLL code project and .h file with API macros](../code-quality/media/utecpp07.png "UteCpp07")  
...
1.  Add the DLL project to the project references of the test project:  
    ...
    1.  Open the properties of the test project and choose **Common Properties**, **Framework and References**.  
         ...
         ![C&#43;&#43; project properties &#45; Framework and References](../code-quality/media/utecpp08.png "UteCpp08")  
  
    2.  Choose **Add New Reference**.  
  
         In the **Add Reference** dialog box, select the DLL project and choose **Add**.  
  
         ![C&#43;&#43; project properties &#45; Add New Reference](../code-quality/media/utecpp09.png "UteCpp09")  
...
5.  In Test Explorer, choose **Run All**.  
     ...
     ![Unit Test Explorer &#45; Basic Test passed](../code-quality/media/utecpp10.png "UteCpp10")  
...
4.  Build the solution and then in Test Explorer, choose **Run All**.  
     ...
     ![Unit Test Explorer &#45; Range Test passed](../code-quality/media/utecpp12.png "UteCpp12")  
...
## See Also  
 ...
 [Using Microsoft.VisualStudio.TestTools.CppUnitTestFramework](../code-quality/using-microsoft.visualstudio.testtools.cppunittestframework.md)   

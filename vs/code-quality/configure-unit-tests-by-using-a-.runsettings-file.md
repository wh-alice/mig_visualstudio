---
title: "Configure unit tests by using a .runsettings file | hehe"
ms.custom: ""
ms.date: "10/19/2016"
...
```  
 ...
 The .runsettings file is also used to configure [Code Coverage](../code-quality/customizing-code-coverage-analysis.md).  
...
#### Code coverage adapter  
 The code coverage data collector creates a log of which parts of the application code have been exercised in the test. For more information about customizing the settings for code coverage, see [Customizing Code Coverage Analysis](../code-quality/customizing-code-coverage-analysis.md).  

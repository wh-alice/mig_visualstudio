---
title: "Customizing Code Coverage Analysis | hehe"
ms.custom: ""
ms.date: "10/19/2016"
...
By default, the Visual Studio Code Coverage tool analyzes all solution assemblies (.exe/.dll) that are loaded during unit tests. We recommend that you retain this default, because it works well most of the time. For more information, see [Using Code Coverage to Determine How Much Code is being Tested](../code-quality/using-code-coverage-to-determine-how-much-code-is-being-tested.md).  
...
5.  To turn the custom settings off and on, deselect or select the file in the **Test**, **Test Settings** menu.  
 ...
 ![Test settings menu with custom settings file](../code-quality/media/codecoverage-settingsfile.png "CodeCoverage-settingsFile")  
  
 Other aspects of unit tests can be configured in the same .runsettings file. For more information, see [Unit Test Your Code](../code-quality/unit-test-your-code.md).  
...
### To customize run settings in a build definition  
 ...
 ![Specifying runsettings in a build definition](../code-quality/media/codecoverage-buildrunsettings.png "CodeCoverage-buildRunsettings")  
...
##  <a name="sample"></a> Sample .runsettings file  
 ...
 (For other uses of the .runsettings file, see [Configure unit tests by using a .runsettings file](../code-quality/configure-unit-tests-by-using-a-.runsettings-file.md).)  

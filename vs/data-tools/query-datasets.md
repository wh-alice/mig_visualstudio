...
---
# Query datasets
To search for specific records in a dataset,  use the FindBy method on the DataTable, write your own foreach loop over the table's rows collection, or use [LINQ to DataSet](http://msdn.microsoft.com/en-us/Library/743e3755-3ecb-45a2-8d9b-9ed41f0dcf17). LINQ to DataSet.  
...
## Accessrelated records  
 ...
 This page provides examples using typed datasets. For information about navigating relationships in untyped datasets, see [Navigating DataRelations](http://msdn.microsoft.com/en-us/Library/e5e673f4-9b44-45ae-aaea-c504d1cc5d3e).  

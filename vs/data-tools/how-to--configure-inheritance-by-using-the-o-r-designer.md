---
title: "How to: Configure inheritance by using the O-R Designer | testtitle"
ms.custom: ""
ms.date: "10/19/2016"
...
5.  In each class, delete any object properties that you do not want to appear and that are not used for associations. You will receive an error if you attempt to delete object properties used for associations: [The property \<property name> cannot be deleted because it is participating in the association \<association name>](../data-tools/389873cc-92dd-48da-bfca-0f6c8e0ae3c2.md).  

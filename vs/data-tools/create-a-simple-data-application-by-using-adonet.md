...
> [!NOTE]
>  In a real application, you should store the connection string securely, as described in [Connection Strings and Configuration Files](http://msdn.microsoft.com/en-us/Library/37df2641-661e-407a-a3fb-7bf9540f01e8).  

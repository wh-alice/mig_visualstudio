...
1.  Add new records to the desired <xref:System.Data.DataTable> by creating a new <xref:System.Data.DataRow> and adding it to the <xref:System.Data.DataTable.Rows%2A> collection. For more information, see [How to: Add Rows to a DataTable](http://msdn.microsoft.com/en-us/Library/78ebbb43-c402-49cf-81da-0715289487bf).  

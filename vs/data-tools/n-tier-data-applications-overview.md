...
-   [LINQ to SQL](http://msdn.microsoft.com/en-us/Library/73d13345-eece-471a-af40-4cc7a2f11655) provides the <xref:System.Data.Linq.Table%601.Attach%2A> method that enables you to bring together the DataContext from different tiers in an application. For more information, see [N-Tier and Remote Applications with LINQ to SQL](http://msdn.microsoft.com/en-us/Library/854a1cdd-53cb-45f5-83ca-63962a9b3598).  
...
-   Object representations of data, such as [LINQ to SQL](http://msdn.microsoft.com/en-us/Library/73d13345-eece-471a-af40-4cc7a2f11655) entity classes for use in the presentation tier.  
...
-   Data access components and logic, such as the following:  
    ...
    -   [TableAdapters](http://msdn.microsoft.com/en-us/Library/09416de9-134c-4dc7-8262-6c8d81e3f364) and [DataAdapters and DataReaders](http://msdn.microsoft.com/en-us/Library/cc952ca2-ec19-46ab-9189-15174b52cb74).  
  
    -   Object representations of data, such as [LINQ to SQL](http://msdn.microsoft.com/en-us/Library/73d13345-eece-471a-af40-4cc7a2f11655) entity classes.  
...
## Help for N-Tier Development  
 ...
 [Walkthrough: Adding Validation to an N-Tier Data Application](http://msdn.microsoft.com/en-us/Library/b35d072c-31f0-49ba-a225-69177592c265)  
